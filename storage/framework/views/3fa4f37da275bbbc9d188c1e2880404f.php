                ...
                <tbody>
                    <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $cart_items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cart_item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr wire:key="cart-<?php echo e($cart_item->rowId); ?>">
                            ...
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('access_wash_area')): ?>
                            <td class="align-middle text-center">
                                <span wire:click="toggleLavado('<?php echo e($cart_item->rowId); ?>', <?php echo e($cart_item->id); ?>)"
                                      role="button" title="Click para cambiar"
                                      class="badge <?php echo e(($cart_item->options->product_lavado ?? false) ? 'badge-success' : 'badge-secondary'); ?>">
                                    <?php echo e(($cart_item->options->product_lavado ?? false) ? 'SI' : 'NO'); ?>
                    ...
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                        <tr>
                            <td colspan="<?php echo e(auth()->user()->can('access_wash_area') ? 8 : 7); ?>" class="text-center">
            ...
            <div class="table-responsive">
                <table class="table table-striped">
                    <tr>
                        ...
                        <?php $total_package = Cart::instance($cart_instance)->subtotal() ?>
