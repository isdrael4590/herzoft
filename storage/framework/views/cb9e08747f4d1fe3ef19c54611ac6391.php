<?php $__env->startSection('title', 'Envío al Almacén'); ?>
...
<?php $__env->startSection('content'); ?>
    <div class="container-fluid mb-4">
            ...
            <div class="d-flex align-items-center">
                ...
                <div>
                    ...
                    <small class="text-muted">
                        Ciclo: <strong class="text-dark"><?php echo e($stock->reference); ?></strong>
                        &nbsp;&bull;&nbsp; Equipo: <strong class="text-dark"><?php echo e($stock->machine_name); ?></strong>
                    </small>
                </div>
            </div>
        ...
        <form id="stock-form" action="<?php echo e(route('stocks.store')); ?>" method="POST" onsubmit="return handleFormSubmit(event)">
            <?php echo csrf_field(); ?>
            <input type="hidden" name="form_token" value="<?php echo e(uniqid('stock_', true)); ?>">
                    ...
                    <div class="form-row">
                        ...
                        <div class="col-lg-2 col-md-4 col-sm-6 mb-3">
                            ...
                            <input type="text" class="form-control form-control-sm" name="machine_type"
                                value="<?php echo e($stock->machine_type); ?>" readonly
                                style="background:#f8fafc;border-color:#e2e8f0;border-radius:8px;">
                        </div>
                        ...
                        <div class="col-lg-2 col-md-4 col-sm-6 mb-3">
                            ...
                            <input type="number" class="form-control form-control-sm" name="temp_ambiente"
                                value="<?php echo e($stock->temp_ambiente); ?>" min="1" step="0.1" required
            ...
            <div class="card border-0 mb-4" style="border-radius:12px;box-shadow:0 2px 20px rgba(0,0,0,0.08);">
                ...
                <div class="card-body" style="padding:24px;">
                    <textarea name="note" id="note" rows="3" class="form-control"
                        ...
                        style="border-radius:8px;resize:none;"><?php echo e($stock->note); ?></textarea>
