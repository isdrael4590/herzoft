...
<?php $__env->startSection('content'); ?>
    <div class="container-fluid mb-4">
        <form action="<?php echo e(route('area.store')); ?>" method="POST" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="category_code" required readonly
                                    value="<?php echo e($category_code); ?>"
                                    style="border-radius:8px;border-color:#e2e8f0;padding:10px 14px;background:#f8fafc;">
                            </div>
                        </div>
                    </div>
...
unset($__errorArgs, $__bag); ?>"
                                    ...
                                    value="<?php echo e(old('area_name')); ?>"
...
unset($__errorArgs, $__bag); ?>"
                                    ...
                                    value="<?php echo e(old('area_responsable')); ?>"
                                    style="border-radius:8px;border-color:#e2e8f0;padding:10px 14px;">
...
unset($__errorArgs, $__bag); ?>"
                                    ...
                                    value="<?php echo e(old('area_piso')); ?>"
                                    style="border-radius:8px;border-color:#e2e8f0;padding:10px 14px;">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/Modules/Informat/Resources/views/areas/create.blade.php ENDPATH**/ ?>