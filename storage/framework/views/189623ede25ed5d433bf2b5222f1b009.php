                    ...
                    <ul id="search-results-list-qr" class="list-group list-group-flush">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $search_results; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $result): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <li class="list-group-item list-group-item-action search-result-item"
                                ...
                                <a href="#" :class="focusedIndex === <?php echo e($loop->index); ?> ? 'text-white' : ''">
                                    <i class="bi bi-box-seam"></i>
                                    <?php echo e($result->product_name); ?>

                                    <span class="badge badge-info ml-1"><?php echo e($result->product_code); ?></span>
                                    <span class="badge badge-success ml-1"><?php echo e($result->product_quantity); ?> Un</span>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($result->product_area): ?>
                                        <span class="badge badge-secondary ml-1"><?php echo e($result->product_area); ?></span>
                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($result->product_patient): ?>
                                        <span class="badge badge-warning ml-1"><i class="bi bi-person"></i> <?php echo e($result->product_patient); ?></span>
                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($result->product_outside_company): ?>
                                        <span class="badge badge-primary ml-1"><i class="bi bi-building"></i> <?php echo e($result->product_outside_company); ?></span>
                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($result->product_info): ?>
                                        <span class="badge badge-light text-dark ml-1"><i class="bi bi-info-circle"></i> <?php echo e($result->product_info); ?></span>
                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                </a>
                            </li>
...
<?php /**PATH /var/www/html/resources/views/livewire/search-producttoQR.blade.php ENDPATH**/ ?>