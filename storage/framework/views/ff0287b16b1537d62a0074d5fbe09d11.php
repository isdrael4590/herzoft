    ...
    <div class="container">
        ...
        <?php if($isExpired): ?>
            <div class="alert alert-warning alert-dismissible fade show" role="alert">
                ...
                <p class="mb-0">
                    La licencia del sistema está expirada.
                    <strong>Contactese con el administrador</strong> para renovar la licencia.
                    Si no es administrador, contacte con el personal autorizado.
                </p>
        ...
        <div class="row mb-3">
            <div class="col-12 d-flex justify-content-center">
                <img width="300" src="<?php echo e(settings()->getFirstMediaUrl('settings')); ?>" alt="Logo">
...
unset($__errorArgs, $__bag); ?>
                ...
                <p class="text-center mt-10 lead">
                    Desarrollado por
                    <a href="http://www.herzgroup.net/" class="font-weight-bold text-primary">
                        <?php echo e(Settings()->company_name); ?></a>
                    <br>
        ...
        <footer class="c-footer">
            <div>herZoft <?php echo e(date('Y')); ?> || Todos los derechos son reservados con <strong><a
                        href="http://www.herzgroup.net/">Herz Group</a></strong></div>
