...
<?php $__env->startSection('content'); ?>
    <div class="container-fluid mb-4">
        <form action="<?php echo e(route('proceso.update', $proceso->id)); ?>" method="POST">
            <?php echo csrf_field(); ?>
            ...
            <div class="d-flex align-items-center justify-content-between mb-4">
                <div class="d-flex align-items-center">
                    ...
                    <div>
                        <h4 class="mb-0 font-weight-bold text-dark">Editar Proceso</h4>
                        <small class="text-muted">
                            Modificando: <strong class="text-dark"><?php echo e($proceso->proceso_name); ?></strong>
                            &nbsp;&bull;&nbsp;
                            <span class="text-muted"><?php echo e($proceso->proceso_code); ?></span>
                        </small>
                    </div>
                </div>
                <div class="d-flex" style="gap:10px;">
                    ...
                    <button type="submit"
                        ...
                        <i class="bi bi-check-lg mr-2"></i> Actualizar Proceso
                    </button>
                </div>
            </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group mb-0">
                                ...
                                <input class="form-control" type="text" name="proceso_code" required
                                    value="<?php echo e($proceso->proceso_code); ?>"
...
unset($__errorArgs, $__bag); ?>"
                                    ...
                                    value="<?php echo e(old('proceso_name', $proceso->proceso_name)); ?>"
...
unset($__errorArgs, $__bag); ?>"
                                    ...
                                    <option value="ALTA TEMPERATURA" <?php echo e(old('proceso_type', $proceso->proceso_type) == 'ALTA TEMPERATURA' ? 'selected' : ''); ?>>ALTA TEMPERATURA</option>
                                    <option value="BAJA TEMPERATURA" <?php echo e(old('proceso_type', $proceso->proceso_type) == 'BAJA TEMPERATURA' ? 'selected' : ''); ?>>BAJA TEMPERATURA</option>
                                    <option value="LAVADO" <?php echo e(old('proceso_type', $proceso->proceso_type) == 'LAVADO' ? 'selected' : ''); ?>>LAVADO</option>
                                </select>
...
unset($__errorArgs, $__bag); ?>"
                                    type="number" name="proceso_temp" required
                                    placeholder="Ej: 134°C"
                                    value="<?php echo e(old('proceso_temp', $proceso->proceso_temp)); ?>" °C
                                    style="border-radius:8px;border-color:#e2e8f0;padding:10px 14px;">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/Modules/Informat/Resources/views/procesos/edit.blade.php ENDPATH**/ ?>