<?php $__env->startSection('title', 'Detalle Test Vacío'); ?>

<?php $__env->startSection('breadcrumb'); ?>
    <ol class="breadcrumb border-0 m-0">
        <li class="breadcrumb-item"><a href="<?php echo e(route('home')); ?>">Home</a></li>
        <li class="breadcrumb-item"><a href="<?php echo e(route('testvacuums.index')); ?>">Test Vacío</a></li>
    ...
    <div class="container-fluid mb-4">
        ...
        <div class="d-flex align-items-center justify-content-between mb-4">
            <div class="d-flex align-items-center">
                ...
                <div>
                    <h4 class="mb-0 font-weight-bold text-dark"><?php echo e($testvacuum->testvacuum_reference); ?></h4>
                    <small class="text-muted">
                        Equipo: <strong class="text-dark"><?php echo e($testvacuum->machine_name); ?></strong>
                        &nbsp;&bull;&nbsp;
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($testvacuum->validation_vacuum === 'Correcto'): ?>
            ...
            <div class="d-flex" style="gap:10px;">
                <a href="<?php echo e(route('testvacuums.index')); ?>"
                ...
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('print_testbds')): ?>
                    <a target="_blank" href="<?php echo e(route('testvacuums.pdf', $testvacuum->id)); ?>"
                        class="btn btn-outline-dark d-flex align-items-center"
                        style="border-radius:8px;padding:9px 18px;font-weight:600;">
                        <i class="bi bi-printer mr-2"></i> Imprimir
                    </a>
                <?php endif; ?>
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('edit_testvacuums')): ?>
                    <a href="<?php echo e(route('testvacuums.edit', $testvacuum->id)); ?>"
        ...
        <div class="row">
            ...
            <div class="col-lg-8">
                    ...
                    <div class="card-body" style="padding:24px;">
                        <div class="d-flex align-items-start">
                            ...
                            <div>
                                ...
                                <p class="mb-0 font-weight-bold text-dark" style="font-size:1.1rem;"><?php echo e($testvacuum->testvacuum_reference); ?></p>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="col-md-4 mb-3">
                                <div class="d-flex align-items-start">
                                    ...
                                    <div>
                                        ...
                                        <p class="mb-0 font-weight-semibold text-dark"><?php echo e($testvacuum->machine_name); ?></p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-4 mb-3">
                                <div class="d-flex align-items-start">
                                    ...
                                    <div>
                                        ...
                                        <p class="mb-0 font-weight-semibold text-dark"><?php echo e($testvacuum->tipo_equipo); ?></p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-4 mb-3">
                                <div class="d-flex align-items-start">
                                    ...
                                    <div>
                                        ...
                                        <p class="mb-0 font-weight-semibold text-dark"><?php echo e($testvacuum->lote_machine); ?></p>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-md-6 mb-3">
                                <div class="d-flex align-items-start">
                                    ...
                                    <div>
                                        ...
                                        <p class="mb-0 font-weight-semibold text-dark"><?php echo e($testvacuum->temp_ambiente); ?> °C</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6 mb-3">
                                <div class="d-flex align-items-start">
                                    ...
                                    <div>
                                        ...
                                        <p class="mb-0 font-weight-semibold text-dark"><?php echo e($testvacuum->operator); ?></p>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($testvacuum->observation): ?>
                    <div class="card border-0 mb-4" style="border-radius:12px;box-shadow:0 2px 20px rgba(0,0,0,0.08);">
                        <div class="card-header border-0 d-flex align-items-center"
                        ...
                        <div class="card-body" style="padding:24px;">
                            <p class="mb-0 text-dark" style="line-height:1.7;"><?php echo e($testvacuum->observation); ?></p>
                        </div>
                    </div>
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                ...
                <div class="card border-0 mb-4" style="border-radius:12px;box-shadow:0 2px 20px rgba(0,0,0,0.08);">
                    ...
                    <div class="card-body text-center" style="padding:28px 24px;">
                        ...
                        <div class="d-flex align-items-center justify-content-between mb-2">
                            ...
                            <span class="font-weight-semibold text-dark"><?php echo e($testvacuum->tipo_equipo); ?></span>
                        </div>
                        <div class="d-flex align-items-center justify-content-between">
                            <span class="text-muted" style="font-size:.85rem;">Temperatura ambiente:</span>
                            <span class="font-weight-semibold text-dark"><?php echo e($testvacuum->temp_ambiente); ?> °C</span>
                        </div>
                    </div>
                </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/Modules/Testbd/Resources/views/testvacuums/show.blade.php ENDPATH**/ ?>