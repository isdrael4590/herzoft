...
<body>
            ...
            <table style="width:100%">
                <head>
                    ...
                    <tr style="text-align: center;">
                        <td><img src="data:image/png;base64, <?php echo e(base64_encode(QrCode::format('png')->size(120)->generate($dataqr))); ?>">
                        </td>
                        <td>
                    ...
                    <tr>
                    <td rowspan="3"  >
                            <p class="verticalText" > <?php echo e(Settings()->company_name); ?>-<?php echo e(Settings()->company_email); ?> </p>
                  </td>
                    </tr>
  ...
  <?php /**PATH /var/www/html/Modules/Labelqr/Resources/views/labelqrs/print2.blade.php ENDPATH**/ ?>