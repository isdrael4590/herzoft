<div class="d-inline-block">
    ...
    <span
        wire:click="$dispatch('InputWrap_packageRefresh', { product_id: <?php echo e($cart_item->id); ?>, row_id: '<?php echo e($cart_item->rowId); ?>' })"
        role="button" class="badge badge-warning pointer-event" data-toggle="modal"
        data-target="#InputWrap_package<?php echo e($cart_item->id); ?>">
        <i class="bi bi-pencil-square text-white"></i>
    </span>
    <!-- Discount Modal -->
    <div wire:ignore.self class="modal fade" id="InputWrap_package<?php echo e($cart_item->id); ?>" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <!--[if BLOCK]><![endif]--><?php if(session()->has('message_InputWrap_package' . $cart_item->id)): ?>
                        <div class="alert alert-success alert-dismissible fade show" role="alert">
                            <div class="alert-body">
                                <span><?php echo e(session('message_InputWrap_package' . $cart_item->id)); ?></span>
                    ...
                    <div class="form-group">
                        ...
                        <select wire:model.live="package_wrap.<?php echo e($cart_item->id); ?>" class="form-control" required>
                    ...
                    <div class="form-group">
                        ...
                        <select wire:model.live="eval_indicator.<?php echo e($cart_item->id); ?>" class="form-control" required>
                    ...
                    <div class="form-group">
                        ...
                        <select wire:model.live="expiration.<?php echo e($cart_item->id); ?>" class="form-control" required>
