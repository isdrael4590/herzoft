<?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('edit_machines')): ?>
    <a href="<?php echo e(route('machine.edit', $data->id)); ?>" class="btn btn-info btn-sm">
        <i class="bi bi-pencil"></i>
    </a>
<?php endif; ?>
<?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('delete_machines')): ?>
