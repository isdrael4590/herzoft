<div>
    ...
    <form id="printForm" method="POST" action="<?php echo e(route('printtestbd.post')); ?>" style="display: none;" target="_blank">
        <?php echo csrf_field(); ?>
                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <select wire:model="machine_name" class="form-control" name="machine_name">
                                    ...
                                    <!--[if BLOCK]><![endif]--><?php $__currentLoopData = \Modules\Informat\Entities\Machine::all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $machines): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <div class="card-body">
                        ...
                        <div class="col-md-8">
                            ...
                            <div class="btn-group mb-2 ml-2" role="group">
                                ...
                                <div class="dropdown-menu">
                                    ...
                                    <!--[if BLOCK]><![endif]--><?php $__currentLoopData = collect($data)->pluck('machine_name')->unique(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $machine): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <!--[if BLOCK]><![endif]--><?php if($machine): ?>
                                            <a class="dropdown-item" href="#"
                                                wire:click="selectByMachine('<?php echo e($machine); ?>')">
                                                <?php echo e($machine); ?>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="d-flex justify-content-between align-items-center mb-3">
                                <div>
                                    ...
                                    <span class="badge badge-success mr-2">
                                        <i class="fas fa-check"></i> Válidos: <?php echo e($this->validItemsCount); ?>

                                    </span>
                                    <span class="badge badge-danger">
                                        <i class="fas fa-times"></i> Inválidos: <?php echo e($this->invalidItemsCount); ?>
                            ...
                            <div class="d-flex flex-wrap align-items-center" style="gap: 0.5rem;">
                                ...
                                <!--[if BLOCK]><![endif]--><?php if($this->selectedCount > 1000): ?>
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered table-striped text-center mb-0">
                            ...
                            <tbody>
                                <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $testbd): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <tr class="<?php echo e(in_array($testbd['id'], $selectedItems) ? 'table-success' : ''); ?>">
                                        <td>
                                            <input type="checkbox" wire:model="selectedItems"
                                                value="<?php echo e($testbd['id']); ?>" class="form-check-input">
                                        </td>
                                        <td><?php echo e(\Carbon\Carbon::parse($testbd['updated_at'])->format('d M, Y H:i')); ?>

                                        </td>
                                        <td>
                                            <span class="font-weight-bold"><?php echo e($testbd['testbd_reference']); ?></span>
                                        </td>
                                        <td>
                                            <span
                                                class="badge badge-info"><?php echo e($testbd['machine_name'] ?? 'N/A'); ?></span>
                                        </td>
                                        <td>
                                            <span
                                                class="badge 
                                                <?php if($testbd['validation_bd'] == 'valid'): ?> badge-success
                                                <?php elseif($testbd['validation_bd'] == 'invalid'): ?> badge-danger
                                                <?php elseif($testbd['validation_bd'] == 'pending'): ?> badge-warning
                                                <?php else: ?> badge-secondary <?php endif; ?>">
                                                <?php echo e(ucfirst($testbd['validation_bd'] ?? 'Unknown')); ?>
                                        ...
                                        <td>
                                            ...
                                            <span class="badge badge-secondary">
                                                <?php echo e($testbd['status'] ?? 'Active'); ?>
                            ...
                            <small class="text-muted">
                                ...
                                <!--[if BLOCK]><![endif]--><?php if($this->selectedCount > 0): ?>
                                    | <span class="text-success font-weight-bold"><?php echo e($this->selectedCount); ?>
                                        ...
                                        seleccionados</span>
                                    <!--[if BLOCK]><![endif]--><?php if($this->validItemsCount > 0): ?>
                                        | <span class="text-success font-weight-bold"><?php echo e($this->validItemsCount); ?>

                                            válidos</span>
                                    <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                                    <!--[if BLOCK]><![endif]--><?php if($this->invalidItemsCount > 0): ?>
                                        | <span class="text-danger font-weight-bold"><?php echo e($this->invalidItemsCount); ?>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            window.printSelectedLegacy = function() {
                ...
                try {
                    ...
                    window.Livewire.find('<?php echo e($_instance->getId()); ?>').call('printtbd');
                } catch (error) {
            ...
            window.selectByMachineDynamic = function(machineName) {
                window.Livewire.find('<?php echo e($_instance->getId()); ?>').call('selectByMachine', machineName);
            }
        });
    </script>
<?php $__env->stopPush(); ?>
