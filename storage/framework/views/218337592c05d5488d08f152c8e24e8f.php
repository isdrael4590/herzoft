<?php $__env->startSection('title', 'Editar Despacho'); ?>
            ...
            <div class="d-flex align-items-center">
                ...
                <div>
                    ...
                    <small class="text-muted">
                        Referencia: <strong class="text-dark"><?php echo e($expedition->reference); ?></strong>
                        &nbsp;&bull;&nbsp; Área: <strong class="text-dark"><?php echo e($expedition->area_expedition); ?></strong>
                        &nbsp;&bull;&nbsp;
...
$__key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-3823457683-0', $__key);
...
?>
        ...
        <form id="expedition-form" action="<?php echo e(route('expeditions.update', $expedition)); ?>" method="POST"
            ...
            <input type="hidden" name="form_token" value="<?php echo e(uniqid('expedition_edit_', true)); ?>">
                    ...
                    <div class="form-row">
                        ...
                        <div class="col-lg-2 col-md-4 mb-3">
                            ...
                            <input type="number" class="form-control form-control-sm" name="temp_ambiente" required
                                value="<?php echo e($expedition->temp_ambiente); ?>" min="1" step="0.1"
                        ...
                        <div class="col-lg-3 col-md-6 mb-3">
                            ...
                            <select class="form-control form-control-sm" id="area_expedition" name="area_expedition"
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = \Modules\Informat\Entities\Area::all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $area): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option <?php echo e($expedition->area_expedition == $area->area_name ? 'selected' : ''); ?>
                        ...
                        <div class="col-lg-3 col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control form-control-sm" name="staff_expedition" required
                                value="<?php echo e($expedition->staff_expedition); ?>" style="border-radius:8px;">
                        </div>
...
[$__name, $__params] = $__split('product-carttoEXP', ['cartInstance' => 'expedition','data' => $expedition]);

$__key = null;

$__key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-3823457683-1', $__key);
            ...
            <div class="card border-0 mb-4" style="border-radius:12px;box-shadow:0 2px 20px rgba(0,0,0,0.08);">
                ...
                <div class="card-body" style="padding:24px;">
                    <textarea name="note_expedition" id="note_expedition" rows="3" class="form-control"
                        ...
                        style="border-radius:8px;resize:none;"><?php echo e($expedition->note); ?></textarea>
