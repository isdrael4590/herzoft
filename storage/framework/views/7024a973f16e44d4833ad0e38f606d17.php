                                ...
                                <table class="default-table">
                                    <thead>
                                        <tr>
                                            <th>
                                                <div class="logo">
                                                    <img src="<?php echo e($dataUrl); ?>" alt="Institute Image" >
                                                </div>
                                            </th>
                                            <th>
                                                <h2> <?php echo e($testbd->testbd_reference); ?></h2>
                                                <h3> <span>
                                                        <?php echo e(\Carbon\Carbon::parse($testbd->updated_at)->format('d M, Y')); ?></span>
                                                </h3>
                        ...
                        <div class="product-summary">
                                ...
                                <table class="default-table">
                                    <thead>
                                        <tr>
                                            ...
                                            <th><strong>Información de Test:</strong></h4>
                                            </th>
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                <div>
                                                    <div>Lote del equipo: <strong> <?php echo e($testbd->lote_machine); ?></strong>
                                                    </div>
                                                    <div>Equipo: <strong><?php echo e($testbd->machine_name); ?></strong></div>
                                                    <div>Temperatura del Equipo:<strong>
                                                            <?php echo e($testbd->temp_machine); ?></strong></div>
                                                    <div>Temperatura Ambiente:<strong>
                                                            <?php echo e($testbd->temp_ambiente); ?></strong></div>
                                                    <div>Operario:<strong> <?php echo e($testbd->operator); ?></strong></div>
                                                </div>
                                            </td>
                                            <td>
                                                <div>
                                                    <div> Número: <strong><?php echo e($testbd->testbd_reference); ?></strong>
                                                    </div>
                                                    <div> Fecha:
                                                        <?php echo e(\Carbon\Carbon::parse($testbd->updated_at)->format('d M, Y')); ?>

                                                    </div>
                                                    <div> Hora:
                                                        <?php echo e(\Carbon\Carbon::parse($testbd->updated_at)->isoFormat('H:mm:ss A')); ?>

                                                    </div>
                                                    <div> Lote del Paquete B&D: <strong><?php echo e($testbd->lote_bd); ?></strong>
                                                    </div>
                                                    <div> Validación de Test: <h3><?php echo e($testbd->validation_bd); ?></h3>
                                                    </div>
                                                    <div> Status: <strong><?php echo e($testbd->status); ?></strong>
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
                            ...
                            <div class="product-summary">
                                ...
                                <div class="align-middle">
                                    <img src="data:image/png;base64,<?php echo e(base64_encode(file_get_contents(public_path('/assets/img/impresiones/espacio_impresionbd.png')))); ?>"
                                        height="580" IMA>
                                </div>
                                <br>
                                <div>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(@empty($testbd->note)): ?>
                                        Notas: N/A
                                    <?php else: ?>
                                        Notas: <?php echo e($testbd->note); ?>
                            ...
                            <table class="default-table ">
                                <tr>
                                    <th style= " font-size: 15px; text-align: justify;">
                                        ...
                                        Operario: <span> <?php echo e($testbd->operator); ?></span>
                                        <br><br><br><br><br><br>
                                    </th>
                    ...
                    <div class="printer-informeshon-footer">
                        ...
                        <ul>
                            <li>
                                ...
                                <img src="<?php echo e($dataUrlogo); ?>" alt="Institute Image" class="img-fluid mb-2"
                                    width="80px">
                                <br>
...
<?php /**PATH /var/www/html/Modules/Testbd/Resources/views/testbds/print.blade.php ENDPATH**/ ?>