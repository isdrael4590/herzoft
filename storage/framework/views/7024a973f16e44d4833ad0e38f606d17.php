                            ...
                            <div> <table class="default-table">
                                    <thead>
                                        ...
                                        <img src="<?php echo e($institute->getFirstMediaUrl('institutes')); ?>"
                                            ...
                                            <th><h2># <?php echo e($testbd->testbd_reference); ?></h2>
                                           <h3> <span>     <?php echo e(\Carbon\Carbon::parse($testbd->updated_at)->format('d M, Y')); ?></span></h3>
                                ...
                                <table class="default-table">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                <div>
                                                    <div>Lote del equipo: <strong> <?php echo e($testbd->lote_machine); ?></strong></div>
                                                    <div>Equipo: <strong><?php echo e($testbd->machine_name); ?></strong></div>
                                                    <div>Temperatura del Equipo:<strong> <?php echo e($testbd->temp_machine); ?></strong></div>
                                                    <div>Temperatura Ambiente:<strong> <?php echo e($testbd->temp_ambiente); ?></strong></div>
                                                    <div>Operario:<strong> <?php echo e($testbd->operator); ?></strong></div>
                                                </div>
                                            </td>
                                            <td>
                                                <div>
                                                     <div> Número: <strong><?php echo e($testbd->testbd_reference); ?></strong></div>
                                                    <div> Fecha: <?php echo e(\Carbon\Carbon::parse($testbd->updated_at)->format('d M, Y')); ?>

                                                    </div>
                                                    <div> Hora: <?php echo e(\Carbon\Carbon::parse($testbd->updated_at)->isoFormat('H:mm:ss A')); ?>
