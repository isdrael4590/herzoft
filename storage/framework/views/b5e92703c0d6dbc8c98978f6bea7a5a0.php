...
<?php $__env->startSection('title', 'Registrar Proceso HPO - Baja Temperatura'); ?>

<?php $__env->startSection('breadcrumb'); ?>
    <ol class="breadcrumb border-0 m-0">
        <li class="breadcrumb-item"><a href="<?php echo e(route('home')); ?>">Home</a></li>
        <li class="breadcrumb-item"><a href="<?php echo e(route('labelqrs.index')); ?>">Generador Etiquetas</a></li>
        <li class="breadcrumb-item active">Añadir HPO / Baja Temperatura</li>
    </ol>
...
<?php $__env->startSection('content'); ?>
    <div class="container-fluid mb-4">
        ...
        <div class="mb-3">
            <a href="<?php echo e(route('labelqrs.create')); ?>" class="btn btn-warning">
                <i class="bi bi-thermometer-half"></i> Cambiar a STEAM / Alta Temperatura
            </a>
        </div>
            ...
            <div class="col-md-12">
                <div class="card shadow-sm">
                    <div class="card-header bg-info text-white d-flex align-items-center">
                        <i class="bi bi-droplet-half mr-2" style="font-size:1.3rem;"></i>
                        <div>
                            <h5 class="mb-0">Nuevo Proceso HPO — Baja Temperatura (Peróxido)</h5>
                    ...
                    <div class="card-body">
                        ...
                        <form id="labelqr-form" action="<?php echo e(route('labelqrshpo.store')); ?>" method="POST"
                            onsubmit="return handleFormSubmit(event)">
                            <?php echo csrf_field(); ?>
                            <input type="hidden" name="form_token" value="<?php echo e(uniqid('labelqr_hpo_', true)); ?>">

                            
                            <div class="card border-left-info mb-4" style="border-left: 4px solid #17a2b8;">
                            ...
                            <div class="card border-left-warning mb-4" style="border-left: 4px solid #ffc107;">
                                <div class="card-header bg-light py-2">
                                    ...
                                    <div class="form-row">
                                        <div class="col-lg-3">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" name="lote_agente" required>
                            ...
                            <div class="card border-left-primary mb-4" style="border-left: 4px solid #007bff;">
                                <div class="card-header bg-light py-2">
...
$__html = app('livewire')->mount($__name, $__params, 'lw-1457849687-0', $__slots ?? [], get_defined_vars());
...
?>
                            ...
                            <div class="card border-left-success mb-4" style="border-left: 4px solid #28a745;">
                                <div class="card-header bg-light py-2">
...
[$__name, $__params] = $__split('product-carttoQRHPO', ['cartInstance' => 'labelqrhpo']);

$__html = app('livewire')->mount($__name, $__params, 'lw-1457849687-1', $__slots ?? [], get_defined_vars());
...
?>
                            ...
                            <div class="d-flex justify-content-between align-items-center">
                                <button type="submit" class="btn btn-primary btn-lg" id="submit-btn">
                                    <span id="submit-text"><i class="bi bi-sd-card mr-1"></i> Guardar Proceso HPO</span>
                                </button>
...
<?php $__env->startPush('page_scripts'); ?>
    <script>
        ...
        function resetSubmitButton() {
            ...
            submitText.innerHTML = '<i class="bi bi-sd-card mr-1"></i> Guardar Proceso HPO';
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/Modules/Labelqr/Resources/views/labelqrshpo/create.blade.php ENDPATH**/ ?>