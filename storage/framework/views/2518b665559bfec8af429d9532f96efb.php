                                                ...
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input"
                                                            ...
                                                            <?php echo e($role->hasPermissionTo('show_total_stats') ? 'checked' : ''); ?>>
                                                ...
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input"
                                                            ...
                                                            <?php echo e($role->hasPermissionTo('show_notifications') ? 'checked' : ''); ?>>
                                                ...
                                                <div class="col-12">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input"
                                                            ...
                                                            <?php echo e($role->hasPermissionTo('show_test') ? 'checked' : ''); ?>>
                                                ...
                                                <div class="col-12">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input"
                                                            ...
                                                            <?php echo e($role->hasPermissionTo('show_production') ? 'checked' : ''); ?>>
                                                        <label class="custom-control-label"
                                                ...
                                                <div class="col-12">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input"
                                                            ...
                                                            <?php echo e($role->hasPermissionTo('show_types_rumed') ? 'checked' : ''); ?>>
                                                            <label class="custom-control-label"
                                                ...
                                                <div class="col-12">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input"
                                                            ...
                                                            <?php echo e($role->hasPermissionTo('show_result_biologic') ? 'checked' : ''); ?>>
                                                        <label class="custom-control-label"
                                                ...
                                                <div class="col-12">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input"
                                                            ...
                                                            <?php echo e($role->hasPermissionTo('show_production_areas') ? 'checked' : ''); ?>>
                                                        <label class="custom-control-label"
                                                ...
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input"
                                                            ...
                                                            <?php echo e($role->hasPermissionTo('access_user_management') ? 'checked' : ''); ?>>
                                                        <label class="custom-control-label"
                                                ...
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input"
                                                            ...
                                                            <?php echo e($role->hasPermissionTo('create_user_management') ? 'checked' : ''); ?>>
                                                        <label class="custom-control-label"
                                                ...
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input"
                                                            ...
                                                            <?php echo e($role->hasPermissionTo('edit_user_management') ? 'checked' : ''); ?>>
                                                        <label class="custom-control-label"
                                                ...
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input"
                                                            ...
                                                            <?php echo e($role->hasPermissionTo('delete_user_management') ? 'checked' : ''); ?>>
                                                        <label class="custom-control-label"
                                                ...
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input"
                                                            ...
                                                            <?php echo e($role->hasPermissionTo('edit_own_profile') ? 'checked' : ''); ?>>
                                                ...
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input"
                                                            ...
                                                            <?php echo e($role->hasPermissionTo('access_roles') ? 'checked' : ''); ?>>
                                                ...
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input"
                                                            ...
                                                            <?php echo e($role->hasPermissionTo('create_roles') ? 'checked' : ''); ?>>
                                                ...
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input"
                                                            ...
                                                            <?php echo e($role->hasPermissionTo('edit_roles') ? 'checked' : ''); ?>>
                                                ...
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input"
                                                            ...
                                                            <?php echo e($role->hasPermissionTo('delete_roles') ? 'checked' : ''); ?>>
                                                ...
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input"
                                                            ...
                                                            <?php echo e($role->hasPermissionTo('access_products') ? 'checked' : ''); ?>>
                                                        <label class="custom-control-label"
                                                ...
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input"
                                                            ...
                                                            <?php echo e($role->hasPermissionTo('show_products') ? 'checked' : ''); ?>>
                                                        <label class="custom-control-label"
                                                ...
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input"
                                                            ...
                                                            <?php echo e($role->hasPermissionTo('create_products') ? 'checked' : ''); ?>>
                                                        <label class="custom-control-label"
                                                ...
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input"
                                                            ...
                                                            <?php echo e($role->hasPermissionTo('accces_subproduct') ? 'checked' : ''); ?>>
                                                        <label class="custom-control-label"
                                                ...
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input"
                                                            ...
                                                            <?php echo e($role->hasPermissionTo('edit_products') ? 'checked' : ''); ?>>
                                                        <label class="custom-control-label"
                                                ...
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input"
                                                            ...
                                                            <?php echo e($role->hasPermissionTo('delete_products') ? 'checked' : ''); ?>>
                                                        <label class="custom-control-label"
                                                ...
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input"
                                                            ...
                                                            <?php echo e($role->hasPermissionTo('access_product_categories') ? 'checked' : ''); ?>>
                                                        <label class="custom-control-label"
                                                ...
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input"
                                                            ...
                                                            value="add_image"
                                                            <?php echo e($role->hasPermissionTo('add_image') ? 'checked' : ''); ?>>
                                                        <label class="custom-control-label"
                                                ...
                                                <div class="col-12">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input"
                                                            ...
                                                            <?php echo e($role->hasPermissionTo('create_importproducts') ? 'checked' : ''); ?>>
                                                ...
                                                <div class="col-12">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input"
                                                            ...
                                                            <?php echo e($role->hasPermissionTo('print_barcodes') ? 'checked' : ''); ?>>
                                                ...
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input"
                                                            ...
                                                            <?php echo e($role->hasPermissionTo('access_dirty_area') ? 'checked' : ''); ?>>
                                                ...
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input"
                                                            ...
                                                            <?php echo e($role->hasPermissionTo('access_zne_area') ? 'checked' : ''); ?>>
                                                ...
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input"
                                                            ...
                                                            <?php echo e($role->hasPermissionTo('access_esteril_area') ? 'checked' : ''); ?>>
                                                ...
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input"
                                                            ...
                                                            <?php echo e($role->hasPermissionTo('access_almacen_area') ? 'checked' : ''); ?>>
                                                ...
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input"
                                                            ...
                                                            <?php echo e($role->hasPermissionTo('access_receptions') ? 'checked' : ''); ?>>
                                                        <label class="custom-control-label"
                                                ...
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input"
                                                            ...
                                                            <?php echo e($role->hasPermissionTo('show_receptions') ? 'checked' : ''); ?>>
                                                        <label class="custom-control-label"
                                                ...
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input"
                                                            ...
                                                            <?php echo e($role->hasPermissionTo('create_receptions') ? 'checked' : ''); ?>>
                                                        <label class="custom-control-label"
                                                ...
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input"
                                                            ...
                                                            <?php echo e($role->hasPermissionTo('create_reception_preparations') ? 'checked' : ''); ?>>
                                                        <label class="custom-control-label"
                                                ...
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input"
                                                            ...
                                                            <?php echo e($role->hasPermissionTo('edit_receptions') ? 'checked' : ''); ?>>
                                                        <label class="custom-control-label"
                                                ...
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input"
                                                            ...
                                                            <?php echo e($role->hasPermissionTo('print_receptions') ? 'checked' : ''); ?>>
                                                        <label class="custom-control-label"
                                                ...
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input"
                                                            ...
                                                            <?php echo e($role->hasPermissionTo('print_receptionsticket') ? 'checked' : ''); ?>>
                                                        <label class="custom-control-label"
                                                ...
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input"
                                                            ...
                                                            <?php echo e($role->hasPermissionTo('delete_receptions') ? 'checked' : ''); ?>>
                                                        <label class="custom-control-label"
                                                ...
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input"
                                                            ...
                                                            <?php echo e($role->hasPermissionTo('access_wash_area') ? 'checked' : ''); ?>>
                                                        <label class="custom-control-label"
                                                ...
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input"
                                                            ...
                                                            <?php echo e($role->hasPermissionTo('show_wash_area') ? 'checked' : ''); ?>>
                                                        <label class="custom-control-label"
                                                ...
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input"
                                                            ...
                                                            <?php echo e($role->hasPermissionTo('create_wash_area') ? 'checked' : ''); ?>>
                                                        <label class="custom-control-label"
                                                ...
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input"
                                                            ...
                                                            <?php echo e($role->hasPermissionTo('edit_wash_area') ? 'checked' : ''); ?>>
                                                        <label class="custom-control-label"
                                                ...
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input"
                                                            ...
                                                            <?php echo e($role->hasPermissionTo('delete_wash_area') ? 'checked' : ''); ?>>
                                                        <label class="custom-control-label"
                                                ...
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input"
                                                            ...
                                                            <?php echo e($role->hasPermissionTo('access_testbds') ? 'checked' : ''); ?>>
                                                        <label class="custom-control-label"
                                                ...
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input"
                                                            ...
                                                            <?php echo e($role->hasPermissionTo('show_testbds') ? 'checked' : ''); ?>>
                                                        <label class="custom-control-label"
                                                ...
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input"
                                                            ...
                                                            <?php echo e($role->hasPermissionTo('create_testbds') ? 'checked' : ''); ?>>
                                                        <label class="custom-control-label"
                                                ...
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input"
                                                            ...
                                                            <?php echo e($role->hasPermissionTo('edit_testbds') ? 'checked' : ''); ?>>
                                                        <label class="custom-control-label"
                                                ...
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input"
                                                            ...
                                                            <?php echo e($role->hasPermissionTo('print_testbds') ? 'checked' : ''); ?>>
                                                        <label class="custom-control-label"
                                                ...
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input"
                                                            ...
                                                            <?php echo e($role->hasPermissionTo('delete_testbds') ? 'checked' : ''); ?>>
                                                        <label class="custom-control-label"
                                                ...
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input"
                                                            ...
                                                            <?php echo e($role->hasPermissionTo('access_testvacuums') ? 'checked' : ''); ?>>
                                                        <label class="custom-control-label"
                                                ...
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input"
                                                            ...
                                                            <?php echo e($role->hasPermissionTo('show_testvacuums') ? 'checked' : ''); ?>>
                                                        <label class="custom-control-label"
                                                ...
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input"
                                                            ...
                                                            <?php echo e($role->hasPermissionTo('create_testvacuums') ? 'checked' : ''); ?>>
                                                        <label class="custom-control-label"
                                                ...
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input"
                                                            ...
                                                            <?php echo e($role->hasPermissionTo('edit_testvacuums') ? 'checked' : ''); ?>>
                                                        <label class="custom-control-label"
                                                ...
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input"
                                                            ...
                                                            <?php echo e($role->hasPermissionTo('print_testvacuums') ? 'checked' : ''); ?>>
                                                        <label class="custom-control-label"
                                                ...
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input"
                                                            ...
                                                            <?php echo e($role->hasPermissionTo('delete_testvacuums') ? 'checked' : ''); ?>>
                                                        <label class="custom-control-label"
                                                ...
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input"
                                                            ...
                                                            <?php echo e($role->hasPermissionTo('access_preparations') ? 'checked' : ''); ?>>
                                                        <label class="custom-control-label"
                                                ...
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input"
                                                            ...
                                                            <?php echo e($role->hasPermissionTo('show_preparations') ? 'checked' : ''); ?>>
                                                        <label class="custom-control-label"
                                                ...
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input"
                                                            ...
                                                            <?php echo e($role->hasPermissionTo('create_preparations') ? 'checked' : ''); ?>>
                                                        <label class="custom-control-label"
                                                ...
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input"
                                                            ...
                                                            <?php echo e($role->hasPermissionTo('edit_preparations') ? 'checked' : ''); ?>>
                                                        <label class="custom-control-label"
                                                    ...
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input"
                                                            ...
                                                            <?php echo e($role->hasPermissionTo('reset_preparations') ? 'checked' : ''); ?>>
                                                        <label class="custom-control-label"
                                                ...
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input"
                                                            ...
                                                            <?php echo e($role->hasPermissionTo('delete_preparations') ? 'checked' : ''); ?>>
                                                        <label class="custom-control-label"
                                                ...
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input"
                                                            ...
                                                            <?php echo e($role->hasPermissionTo('access_labelqrs') ? 'checked' : ''); ?>>
                                                        <label class="custom-control-label"
                                                ...
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input"
                                                            ...
                                                            <?php echo e($role->hasPermissionTo('show_labelqrs') ? 'checked' : ''); ?>>
                                                        <label class="custom-control-label"
                                                ...
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input"
                                                            ...
                                                            <?php echo e($role->hasPermissionTo('create_labelqrs') ? 'checked' : ''); ?>>
                                                        <label class="custom-control-label"
                                                ...
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input"
                                                            ...
                                                            <?php echo e($role->hasPermissionTo('create_labelqrshpo') ? 'checked' : ''); ?>>
                                                        <label class="custom-control-label"
                                                ...
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input"
                                                            ...
                                                            <?php echo e($role->hasPermissionTo('edit_labelqrs') ? 'checked' : ''); ?>>
                                                        <label class="custom-control-label"
                                                ...
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input"
                                                            ...
                                                            <?php echo e($role->hasPermissionTo('print_labelqrs') ? 'checked' : ''); ?>>
                                                        <label class="custom-control-label"
                                                ...
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input"
                                                            ...
                                                            <?php echo e($role->hasPermissionTo('print_labelqrs_direct') ? 'checked' : ''); ?>>
                                                        <label class="custom-control-label"
                                                ...
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input"
                                                            ...
                                                            <?php echo e($role->hasPermissionTo('create_labelqr_discharges') ? 'checked' : ''); ?>>
                                                        <label class="custom-control-label"
                                                ...
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input"
                                                            ...
                                                            <?php echo e($role->hasPermissionTo('delete_labelqrs') ? 'checked' : ''); ?>>
                                                        <label class="custom-control-label"
                                                ...
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input"
                                                            ...
                                                            <?php echo e($role->hasPermissionTo('access_discharges') ? 'checked' : ''); ?>>
                                                        <label class="custom-control-label"
                                                ...
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input"
                                                            ...
                                                            <?php echo e($role->hasPermissionTo('show_discharges') ? 'checked' : ''); ?>>
                                                        <label class="custom-control-label"
                                                ...
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input"
                                                            ...
                                                            <?php echo e($role->hasPermissionTo('create_discharges') ? 'checked' : ''); ?>>
                                                        <label class="custom-control-label"
                                                ...
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input"
                                                            ...
                                                            <?php echo e($role->hasPermissionTo('edit_discharges') ? 'checked' : ''); ?>>
                                                        <label class="custom-control-label"
                                                ...
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input"
                                                            ...
                                                            <?php echo e($role->hasPermissionTo('access_discharge_Details') ? 'checked' : ''); ?>>
                                                        <label class="custom-control-label"
                                                ...
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input"
                                                            ...
                                                            <?php echo e($role->hasPermissionTo('print_discharges') ? 'checked' : ''); ?>>
                                                        <label class="custom-control-label"
                                                ...
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input"
                                                            ...
                                                            <?php echo e($role->hasPermissionTo('create_discharges_stock') ? 'checked' : ''); ?>>
                                                        <label class="custom-control-label"
                                                ...
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input"
                                                            ...
                                                            <?php echo e($role->hasPermissionTo('delete_discharges') ? 'checked' : ''); ?>>
                                                        <label class="custom-control-label"
                                                ...
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input"
                                                            ...
                                                            <?php echo e($role->hasPermissionTo('access_stocks') ? 'checked' : ''); ?>>
                                                        <label class="custom-control-label"
                                                ...
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input"
                                                            ...
                                                            <?php echo e($role->hasPermissionTo('show_stocks') ? 'checked' : ''); ?>>
                                                        <label class="custom-control-label"
                                                ...
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input"
                                                            ...
                                                            <?php echo e($role->hasPermissionTo('create_stocks') ? 'checked' : ''); ?>>
                                                        <label class="custom-control-label"
                                                ...
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input"
                                                            ...
                                                            <?php echo e($role->hasPermissionTo('edit_stocks') ? 'checked' : ''); ?>>
                                                        <label class="custom-control-label"
                                                ...
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input"
                                                            ...
                                                            <?php echo e($role->hasPermissionTo('delete_stocks') ? 'checked' : ''); ?>>
                                                        <label class="custom-control-label"
                                                ...
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input"
                                                            ...
                                                            <?php echo e($role->hasPermissionTo('access_stockManual') ? 'checked' : ''); ?>>
                                                        <label class="custom-control-label"
                                                ...
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input"
                                                            ...
                                                            <?php echo e($role->hasPermissionTo('show_stockManual') ? 'checked' : ''); ?>>
                                                        <label class="custom-control-label"
                                                ...
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input"
                                                            ...
                                                            <?php echo e($role->hasPermissionTo('create_stockManual') ? 'checked' : ''); ?>>
                                                        <label class="custom-control-label"
                                                ...
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input"
                                                            ...
                                                            <?php echo e($role->hasPermissionTo('edit_stockManual') ? 'checked' : ''); ?>>
                                                        <label class="custom-control-label"
                                                ...
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input"
                                                            ...
                                                            <?php echo e($role->hasPermissionTo('delete_stockManual') ? 'checked' : ''); ?>>
                                                        <label class="custom-control-label"
                                                ...
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input"
                                                            ...
                                                            <?php echo e($role->hasPermissionTo('access_expeditions') ? 'checked' : ''); ?>>
                                                        <label class="custom-control-label"
                                                ...
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input"
                                                            ...
                                                            <?php echo e($role->hasPermissionTo('show_expeditions') ? 'checked' : ''); ?>>
                                                        <label class="custom-control-label"
                                                ...
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input"
                                                            ...
                                                            <?php echo e($role->hasPermissionTo('create_expeditions') ? 'checked' : ''); ?>>
                                                        <label class="custom-control-label"
                                                ...
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input"
                                                            ...
                                                            <?php echo e($role->hasPermissionTo('edit_expeditions') ? 'checked' : ''); ?>>
                                                        <label class="custom-control-label"
                                                ...
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input"
                                                            ...
                                                            <?php echo e($role->hasPermissionTo('print_expeditions') ? 'checked' : ''); ?>>
                                                        <label class="custom-control-label"
                                                ...
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input"
                                                            ...
                                                            <?php echo e($role->hasPermissionTo('delete_expeditions') ? 'checked' : ''); ?>>
                                                        <label class="custom-control-label"
                                                ...
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input"
                                                            ...
                                                            <?php echo e($role->hasPermissionTo('access_informat_units') ? 'checked' : ''); ?>>
                                                        <label class="custom-control-label"
                                                ...
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input"
                                                            ...
                                                            <?php echo e($role->hasPermissionTo('show_units') ? 'checked' : ''); ?>>
                                                ...
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input"
                                                            ...
                                                            <?php echo e($role->hasPermissionTo('create_units') ? 'checked' : ''); ?>>
                                                        <label class="custom-control-label"
                                                ...
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input"
                                                            ...
                                                            <?php echo e($role->hasPermissionTo('edit_units') ? 'checked' : ''); ?>>
                                                        <label class="custom-control-label"
                                                ...
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input"
                                                            ...
                                                            <?php echo e($role->hasPermissionTo('delete_units') ? 'checked' : ''); ?>>
                                                        <label class="custom-control-label"
                                                ...
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input"
                                                            ...
                                                            <?php echo e($role->hasPermissionTo('access_informats') ? 'checked' : ''); ?>>
                                                        <label class="custom-control-label"
                                                ...
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input"
                                                            ...
                                                            <?php echo e($role->hasPermissionTo('show_informats') ? 'checked' : ''); ?>>
                                                        <label class="custom-control-label"
                                                ...
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input"
                                                            ...
                                                            <?php echo e($role->hasPermissionTo('create_informats') ? 'checked' : ''); ?>>
                                                        <label class="custom-control-label"
                                                ...
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input"
                                                            ...
                                                            <?php echo e($role->hasPermissionTo('edit_informats') ? 'checked' : ''); ?>>
                                                        <label class="custom-control-label"
                                                ...
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input"
                                                            ...
                                                            <?php echo e($role->hasPermissionTo('delete_informats') ? 'checked' : ''); ?>>
                                                        <label class="custom-control-label"
                                                ...
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input"
                                                            ...
                                                            <?php echo e($role->hasPermissionTo('access_Informat_institutes') ? 'checked' : ''); ?>>
                                                        <label class="custom-control-label"
                                                ...
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input"
                                                            ...
                                                            <?php echo e($role->hasPermissionTo('show_institutes') ? 'checked' : ''); ?>>
                                                        <label class="custom-control-label"
                                                ...
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input"
                                                            ...
                                                            <?php echo e($role->hasPermissionTo('create_institutes') ? 'checked' : ''); ?>>
                                                        <label class="custom-control-label"
                                                ...
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input"
                                                            ...
                                                            <?php echo e($role->hasPermissionTo('edit_institutes') ? 'checked' : ''); ?>>
                                                        <label class="custom-control-label"
                                                ...
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input"
                                                            ...
                                                            <?php echo e($role->hasPermissionTo('delete_institutes') ? 'checked' : ''); ?>>
                                                        <label class="custom-control-label"
                                                ...
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input"
                                                            ...
                                                            <?php echo e($role->hasPermissionTo('access_informat_machines') ? 'checked' : ''); ?>>
                                                        <label class="custom-control-label"
                                                ...
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input"
                                                            ...
                                                            value="show_machines"
                                                            <?php echo e($role->hasPermissionTo('show_machines') ? 'checked' : ''); ?>>
                                                        <label class="custom-control-label"
                                                ...
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input"
                                                            ...
                                                            <?php echo e($role->hasPermissionTo('create_machines') ? 'checked' : ''); ?>>
                                                        <label class="custom-control-label"
                                                ...
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input"
                                                            ...
                                                            value="edit_machines"
                                                            <?php echo e($role->hasPermissionTo('edit_machines') ? 'checked' : ''); ?>>
                                                        <label class="custom-control-label"
                                                ...
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input"
                                                            ...
                                                            <?php echo e($role->hasPermissionTo('delete_machines') ? 'checked' : ''); ?>>
                                                        <label class="custom-control-label"
                                                ...
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input"
                                                            ...
                                                            <?php echo e($role->hasPermissionTo('access_informat_areas') ? 'checked' : ''); ?>>
                                                        <label class="custom-control-label"
                                                ...
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input"
                                                            ...
                                                            <?php echo e($role->hasPermissionTo('show_areas') ? 'checked' : ''); ?>>
                                                        <label class="custom-control-label"
                                                ...
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input"
                                                            ...
                                                            value="create_areas"
                                                            <?php echo e($role->hasPermissionTo('create_areas') ? 'checked' : ''); ?>>
                                                        <label class="custom-control-label"
                                                ...
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input"
                                                            ...
                                                            <?php echo e($role->hasPermissionTo('edit_areas') ? 'checked' : ''); ?>>
                                                        <label class="custom-control-label"
                                                ...
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input"
                                                            ...
                                                            value="delete_areas"
                                                            <?php echo e($role->hasPermissionTo('delete_areas') ? 'checked' : ''); ?>>
                                                        <label class="custom-control-label"
                                                ...
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input"
                                                            ...
                                                            <?php echo e($role->hasPermissionTo('access_informat_proceso') ? 'checked' : ''); ?>>
                                                        <label class="custom-control-label"
                                                ...
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input"
                                                            ...
                                                            <?php echo e($role->hasPermissionTo('show_proceso') ? 'checked' : ''); ?>>
                                                        <label class="custom-control-label"
                                                ...
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input"
                                                            ...
                                                            <?php echo e($role->hasPermissionTo('create_proceso') ? 'checked' : ''); ?>>
                                                        <label class="custom-control-label"
                                                ...
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input"
                                                            ...
                                                            <?php echo e($role->hasPermissionTo('edit_proceso') ? 'checked' : ''); ?>>
                                                        <label class="custom-control-label"
                                                ...
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input"
                                                            ...
                                                            <?php echo e($role->hasPermissionTo('delete_proceso') ? 'checked' : ''); ?>>
                                                        <label class="custom-control-label"
                                                ...
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input"
                                                            ...
                                                            <?php echo e($role->hasPermissionTo('access_informat_lotes') ? 'checked' : ''); ?>>
                                                        <label class="custom-control-label"
                                                ...
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input"
                                                            ...
                                                            <?php echo e($role->hasPermissionTo('show_lotes') ? 'checked' : ''); ?>>
                                                        <label class="custom-control-label"
                                                ...
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input"
                                                            ...
                                                            <?php echo e($role->hasPermissionTo('access_reports') ? 'checked' : ''); ?>>
                                                        <label class="custom-control-label"
                                                ...
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input"
                                                            ...
                                                            <?php echo e($role->hasPermissionTo('create_reports') ? 'checked' : ''); ?>>
                                                        <label class="custom-control-label"
                                                ...
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input"
                                                            ...
                                                            value="edit_reports"
                                                            <?php echo e($role->hasPermissionTo('edit_reports') ? 'checked' : ''); ?>>
                                                        <label class="custom-control-label"
                                                ...
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input"
                                                            ...
                                                            value="print_reports"
                                                            <?php echo e($role->hasPermissionTo('print_reports') ? 'checked' : ''); ?>>
                                                        <label class="custom-control-label"
                                                ...
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input"
                                                            ...
                                                            <?php echo e($role->hasPermissionTo('delete_reports') ? 'checked' : ''); ?>>
                                                        <label class="custom-control-label"
                                                ...
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input"
                                                            ...
                                                            <?php echo e($role->hasPermissionTo('access_settings') ? 'checked' : ''); ?>>
                                                        <label class="custom-control-label"
                                                ...
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input"
                                                            ...
                                                            value="access_admin"
                                                            <?php echo e($role->hasPermissionTo('access_admin') ? 'checked' : ''); ?>>
                                                        <label class="custom-control-label"
                                                ...
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input"
                                                            ...
                                                            <?php echo e($role->hasPermissionTo('show_admin') ? 'checked' : ''); ?>>
                                                        <label class="custom-control-label"
                                                ...
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input"
                                                            ...
                                                            value="create_admin"
                                                            <?php echo e($role->hasPermissionTo('create_admin') ? 'checked' : ''); ?>>
                                                        <label class="custom-control-label"
                                                ...
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input"
                                                            ...
                                                            <?php echo e($role->hasPermissionTo('edit_admin') ? 'checked' : ''); ?>>
                                                        <label class="custom-control-label"
                                                ...
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input"
                                                            ...
                                                            value="print_admin"
                                                            <?php echo e($role->hasPermissionTo('print_admin') ? 'checked' : ''); ?>>
                                                        <label class="custom-control-label"
                                                ...
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input"
                                                            ...
                                                            value="delete_admin"
                                                            <?php echo e($role->hasPermissionTo('delete_admin') ? 'checked' : ''); ?>>
                                                        <label class="custom-control-label"
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/Modules/User/Resources/views/roles/edit.blade.php ENDPATH**/ ?>