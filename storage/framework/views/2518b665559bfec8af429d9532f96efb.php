                                                ...
                                                <div class="col-12">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input"
                                                            ...
                                                            <?php echo e($role->hasPermissionTo('show_test_bd') ? 'checked' : ''); ?>>
                                                ...
                                                <div class="col-12">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input"
                                                            ...
                                                            <?php echo e($role->hasPermissionTo('show_test_vacuum') ? 'checked' : ''); ?>>
                                                        <label class="custom-control-label"
                                                ...
                                                <div class="col-12">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input"
                                                            ...
                                                            <?php echo e($role->hasPermissionTo('show_production_steam') ? 'checked' : ''); ?>>
                                                        <label class="custom-control-label"
                                                ...
                                                <div class="col-12">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input"
                                                            ...
                                                            <?php echo e($role->hasPermissionTo('show_production_hpo') ? 'checked' : ''); ?>>
                                                        <label class="custom-control-label"
                                                ...
                                                <div class="col-12">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input"
                                                            ...
                                                            <?php echo e($role->hasPermissionTo('show_biologic_steam') ? 'checked' : ''); ?>>
                                                        <label class="custom-control-label"
                                                ...
                                                <div class="col-12">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input"
                                                            ...
                                                            <?php echo e($role->hasPermissionTo('show_biologic_hpo') ? 'checked' : ''); ?>>
                                                        <label class="custom-control-label"
                                                ...
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input"
                                                            ...
                                                            <?php echo e($role->hasPermissionTo('access_preparationDetails') ? 'checked' : ''); ?>>
                                                        <label class="custom-control-label"
                                                ...
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input"
                                                            ...
                                                            <?php echo e($role->hasPermissionTo('show_preparationDetails') ? 'checked' : ''); ?>>
                                                        <label class="custom-control-label"
                                                ...
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input"
                                                            ...
                                                            <?php echo e($role->hasPermissionTo('create_preparationDetails') ? 'checked' : ''); ?>>
                                                        <label class="custom-control-label"
                                                ...
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input"
                                                            ...
                                                            <?php echo e($role->hasPermissionTo('edit_preparationDetails') ? 'checked' : ''); ?>>
                                                        <label class="custom-control-label"
                                                ...
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input"
                                                            ...
                                                            <?php echo e($role->hasPermissionTo('delete_preparationDetails') ? 'checked' : ''); ?>>
                                                        <label class="custom-control-label"
                                                ...
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input"
                                                            ...
                                                            value="create_lotes"
                                                            <?php echo e($role->hasPermissionTo('create_lotes') ? 'checked' : ''); ?>>
                                                        <label class="custom-control-label"
                                                ...
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input"
                                                            ...
                                                            <?php echo e($role->hasPermissionTo('edit_lotes') ? 'checked' : ''); ?>>
                                                        <label class="custom-control-label"
                                                ...
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input"
                                                            ...
                                                            value="delete_lotes"
                                                            <?php echo e($role->hasPermissionTo('delete_lotes') ? 'checked' : ''); ?>>
                                                        <label class="custom-control-label"
