<div class="input-group d-flex justify-content-center">
    ...
    <input wire:model.live="quantity.<?php echo e($cart_item->id); ?>"
        ...
        min="1"
        <?php if($cart_instance == 'expedition'): ?> <?php
...
<?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($cart_instance == 'expedition'): ?>
    <?php
        $availableStock = isset($check_quantity[$cart_item->id])
            ? (is_array($check_quantity[$cart_item->id])
                ? (int) implode('', $check_quantity[$cart_item->id])
            ...
            : 0;
    ?>
    <p class="text-muted">Stock: <?php echo e($availableStock); ?></p>
<?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
<?php /**PATH /var/www/html/resources/views/livewire/includes/product-carttoEXP-quantity.blade.php ENDPATH**/ ?>