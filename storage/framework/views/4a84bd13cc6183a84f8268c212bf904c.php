        ...
        <div class="card border-0 mb-4" style="border-radius:12px;box-shadow:0 2px 20px rgba(0,0,0,0.08);">
            ...
            <div class="card-body" style="padding:24px;">
                ...
                <form id="reception-form" action="<?php echo e(route('receptions.update', $reception)); ?>" method="POST"
                    ...
                    <input type="hidden" name="form_token" value="<?php echo e(uniqid('reception_edit_', true)); ?>">
                        ...
                        <div class="col-lg-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="reference" required
                                    value="<?php echo e($reception->reference); ?>" readonly
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="status" id="status" required
                                    ...
                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('access_admin')): ?>
                                        <option <?php echo e($reception->status == 'Procesado' ? 'selected' : ''); ?> value="Procesado">Procesado</option>
                                    <?php endif; ?>
                                </select>
                            </div>
                        </div>
                        <div class="col-lg-12">
                            <div class="form-group">
                                ...
                                <textarea name="note" id="note" rows="4" class="form-control" maxlength="400"
                                    ...
                                    style="border-radius:8px;border-color:#e2e8f0;padding:10px 14px;resize:vertical;"><?php echo e($reception->note); ?></textarea>
                                <small class="text-muted">
                                    <span id="charCount"><?php echo e(strlen($reception->note ?? '')); ?></span>/400 caracteres
                                </small>
                            </div>
                        </div>
                    </div>
