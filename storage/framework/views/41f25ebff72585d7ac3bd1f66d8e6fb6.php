...
<div class="hz-dashboard px-3 px-md-4 pb-5">
            ...
            <div class="d-flex align-items-center justify-content-between flex-wrap gap-3">
                ...
                <div class="hz-hero__left">
                    <div class="hz-hero__greeting">
                        <i class="bi <?php echo e($greetIcon); ?>" style="color:<?php echo e($greetColor); ?>"></i>
                        <?php echo e($greet); ?>,
                    </div>
                    <h2 class="hz-hero__name"><?php echo e(Auth::user()->name); ?></h2>
                    <p class="hz-hero__date" id="heroDate">
                        <?php echo e($today->translatedFormat('l, d \d\e F \d\e Y')); ?>

                    </p>
                </div>

                <div class="hz-clock-box">
                    <div class="hz-clock" id="heroClock"><?php echo e($today->format('H:i:s')); ?></div>
                        ...
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('access_receptions')): ?>
                            <div class="hz-module__links">
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('create_receptions')): ?>
                                    <a href="<?php echo e(route('receptions.create')); ?>" class="hz-pill">
                                        <i class="bi bi-plus-circle"></i> Nuevo Ingreso
                                    </a>
                                <?php endif; ?>
                                <a href="<?php echo e(route('receptions.index')); ?>" class="hz-pill">
                ...
                <div class="col-12 col-sm-6 col-xl-3">
                    <div class="hz-module hz-module--green">
                        ...
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('access_discharges')): ?>
                            <div class="hz-module__links">
                                <a href="<?php echo e(route('discharges.index')); ?>" class="hz-pill">
                    ...
                    <div class="hz-module hz-module--purple">
                        ...
                        <div class="hz-module__links">
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('access_stocks')): ?>
                                <a href="<?php echo e(route('stockDetails.index')); ?>" class="hz-pill">
                                    <i class="bi bi-boxes"></i> Stock
                                </a>
                            <?php endif; ?>
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('access_expeditions')): ?>
                                <a href="<?php echo e(route('expeditions.index')); ?>" class="hz-pill">
    ...
    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('show_types_rumed')): ?>
        <div class="hz-section-label mb-3">
    ...
    <div class="row g-3 mb-4">
        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('show_result_biologic')): ?>
            <div class="col-lg-6">
                <div class="hz-chart-card">
                    <div class="hz-chart-card__head">
                        <div>
        ...
        <?php endif; ?>
        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('show_production_areas')): ?>
            <div class="col-lg-6">
                <div class="hz-chart-card">
                    <div class="hz-chart-card__head">
                        <div>
