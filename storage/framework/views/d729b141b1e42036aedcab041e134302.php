...
[$__name, $__params] = $__split('search-producttoREPROC', []);

$__html = app('livewire')->mount($__name, $__params, 'lw-1589937796-0', $__slots ?? [], get_defined_vars());
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form id="RecepReprocess-form" action="<?php echo e(route('RecepReprocess.store')); ?>" method="POST">
                            <?php echo csrf_field(); ?>
...
[$__name, $__params] = $__split('product-carttoREPROC', ['cartInstance' => 'RecepReprocess']);

$__html = app('livewire')->mount($__name, $__params, 'lw-1589937796-1', $__slots ?? [], get_defined_vars());
