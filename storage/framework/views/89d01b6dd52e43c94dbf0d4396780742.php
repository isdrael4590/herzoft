<?php $__env->startSection('title', 'Lavados'); ?>
    ...
    <div class="container-fluid">
        ...
        <div class="d-flex align-items-center justify-content-between mb-4">
            ...
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('create_wash_area')): ?>
                <a href="<?php echo e(route('lavados.create')); ?>"
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/Modules/Lavado/Resources/views/lavados/index.blade.php ENDPATH**/ ?>