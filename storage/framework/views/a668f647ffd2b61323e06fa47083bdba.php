<?php $__env->startSection('title', 'Gestión de Backups'); ?>
                                ...
                                <div class="card bg-info text-white">
                                    <div class="card-body">
                                        <div class="d-flex justify-content-between">
                                            <div>
                                                <h4><?php echo e($backups->count()); ?></h4>
                            ...
                            <div class="col-md-3">
                                <div class="card bg-success text-white">
                                    <div class="card-body">
                                        <div class="d-flex justify-content-between">
                                            <div>
                                                <h4><?php echo e($backups->sum('size') > 0 ? number_format($backups->sum('size') / 1024 / 1024, 2) : 0); ?>
                            ...
                            <div class="col-md-3">
                                <div class="card bg-warning text-white">
                                    <div class="card-body">
                                        <div class="d-flex justify-content-between">
                                            <div>
                                                <h4><?php echo e(config('database.connections.mysql.database')); ?></h4>
                            ...
                            <div class="col-md-3">
                                <div class="card bg-danger text-white">
                                    <div class="card-body">
                                        <div class="d-flex justify-content-between">
                                            <div>
                                                <h4><?php echo e($backups->count() > 0 ? $backups->first()['date_human'] : 'N/A'); ?>
                                ...
                                <tbody id="backupsTable">
                                    <?php $__empty_1 = true; $__currentLoopData = $backups; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $backup): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <tr>
                                            ...
                                            <td>
                                                <span class="badge bg-secondary"><?php echo e($backup['size_formatted']); ?></span>
                                            </td>
                                            <td>
                                                <div>
                                                    <strong><?php echo e($backup['date']); ?></strong>
                                                    <br>
                                                    <small class="text-muted"><?php echo e($backup['date_human']); ?></small>
                                                </div>
                                            </td>
                                            <td>
                                                <div class="btn-group btn-group-sm" role="group">
                                                    ...
                                                    <button type="button" class="btn btn-outline-warning restore-btn"
                                                        data-filename="<?php echo e($backup['name']); ?>" title="Restaurar">
                                                        <i class="fas fa-undo"></i>
                                                    </button>
                                                    <button type="button" class="btn btn-outline-danger delete-btn"
                                                        data-filename="<?php echo e($backup['name']); ?>" title="Eliminar">
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('#createBackup').on('click', function(e) {
                ...
                const createUrl = '<?php echo e(route("backups.store")); ?>';
            ...
            $('#uploadForm').on('submit', function(e) {
                ...
                // Verificar que la ruta existe
                const uploadUrl = '<?php echo e(route("backups.upload")); ?>';
            ...
            $('#confirmAction').on('click', function(e) {
                ...
                if (action === 'restore') {
                    url = '<?php echo e(route("backups.restore", ":filename")); ?>'.replace(':filename', filename);
                } else if (action === 'delete') {
                    url = '<?php echo e(route("backups.destroy", ":filename")); ?>'.replace(':filename', filename);
                }
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/Modules/Backup/Resources/views/index.blade.php ENDPATH**/ ?>