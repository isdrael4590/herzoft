                    ...
                    <div class="printer-inner-9" id="printer_wrapper">
                        ...
                        <div class="product-summary">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                <div>
                                                    ...
                                                    <div><strong>Lote del Equipo:</strong>
                                                        <?php echo e($discharge->lote_machine); ?></div>
                                                    <div>
                                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($discharge->lote_agente == 'NA'): ?>
                                                        <?php else: ?>
                                                            <strong>Lote Agente Esterilizante:</strong>
                                                            <?php echo e($discharge->lote_agente); ?>

                                                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                                    </div>
                                                    <div><strong>Temperatura del equipo:</strong>
                                                        <?php echo e($discharge->temp_machine); ?></div>
                                                    <div><strong>Tipo de Programa:</strong>
                                                        <?php echo e($discharge->type_program); ?></div>
                                                    <div><strong>Temperatura del Ambiente: </strong>
                                                        <?php echo e($discharge->temp_ambiente); ?>
                                                    ...
                                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($discharge->operator == $discharge->operator_discharge): ?>
                                                        <div><strong>Operario Carga/ Descarga:</strong> <br>
                                                            <?php echo e($discharge->operator_discharge); ?>

                                                        </div>
                                                    <?php else: ?>
                                                        <div><strong>Operario Carga:</strong>
                                                            <?php echo e($discharge->operator); ?></div>
                                                        <div><strong>Operario DesCarga:</strong>
                                                            <?php echo e($discharge->operator_discharge); ?></div>
                                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                                </div>
                                            </td>
                                            <td>
                                            ...
                                            <td style= "text-align:center">
                                                <img
                                                    src="data:image/png;base64, <?php echo e(base64_encode(QrCode::format('png')->size(150)->generate($data))); ?> ">
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
                            ...
                            <div class="product-summary">
                                        ...
                                        <tbody>
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $discharge->dischargeDetails; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr>
                                                    ...
                                                    <td style= "text-align:center">
                                                        <?php echo Carbon\Carbon::parse($item->updated_at)->addDays($item->product_expiration)->format('d M, Y'); ?>
                                ...
                                <br>
                                <div>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(@empty($discharge->note)): ?>
                                        Notas: N/A
                                    <?php else: ?>
