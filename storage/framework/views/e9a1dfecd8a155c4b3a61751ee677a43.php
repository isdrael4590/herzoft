<div class="d-inline-block">
    ...
    <span
        wire:click="$dispatch('inputDyrtStateRefresh', { product_id: <?php echo e($cart_item->id); ?>, row_id: '<?php echo e($cart_item->rowId); ?>' })"
        role="button" class="badge badge-warning pointer-event" data-toggle="modal"
        data-target="#inputDyrtState<?php echo e($cart_item->id); ?>">
        <i class="bi bi-pencil-square text-white"></i>
    </span>
    <!-- Discount Modal -->
    <div wire:ignore.self class="modal fade" id="inputDyrtState<?php echo e($cart_item->id); ?>" tabindex="-1" role="dialog"
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input wire:model="item_product_info.<?php echo e($cart_item->id); ?>" type="text" class="form-control"
                            value="<?php echo e($item_product_info[$cart_item->id]); ?>" maxlength="20">
                    </div>
                    <div class="form-group">
                        <label>Paciente (Solo Casa Comercial) <span class="text-danger">*</span></label>
                        <input wire:model="item_patient.<?php echo e($cart_item->id); ?>" type="text" class="form-control"
                            value="<?php echo e($item_patient[$cart_item->id]); ?>">
                    </div>
                    <div class="form-group">
                        <label>Casa Comercial (Si Aplica) <span class="text-danger">*</span></label>
                        <input wire:model="item_outside_company.<?php echo e($cart_item->id); ?>" type="text"
                            class="form-control" value="<?php echo e($item_outside_company[$cart_item->id]); ?>">
                    </div>
