<div>
    ...
    <form id="printForm" method="POST" action="<?php echo e(route('printexpedition.post')); ?>" style="display: none;"
        target="_blank">
        <?php echo csrf_field(); ?>
                ...
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered table-striped text-center mb-0">
                            ...
                            <tbody>
                                <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $expedition): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <tr
                                        class="<?php echo e(in_array($expedition['id'], $selectedItems) ? 'table-success' : ''); ?>">
                                        <td>
                                            <input type="checkbox" wire:model="selectedItems"
                                                value="<?php echo e($expedition['id']); ?>" class="form-check-input">
                                        </td>
                                        <td><?php echo e(\Carbon\Carbon::parse($expedition['updated_at'])->format('d M, Y')); ?>

                                        </td>
                                        <td>
                                            <span class="font-weight-bold"><?php echo e($expedition['reference']); ?></span>
                                        </td>
                                        <td><?php echo e($expedition['area_expedition']); ?></td>
                                        <td>
                                            <span
                                                class="badge 
                                                <?php if($expedition['status_expedition'] == 'Despachado'): ?> badge-primary
                                                <?php elseif($expedition['status_expedition'] == 'Pendiente'): ?> badge-info
...
<?php $__env->stopPush(); ?><?php /**PATH /var/www/html/resources/views/livewire/reports/expeditions-report.blade.php ENDPATH**/ ?>