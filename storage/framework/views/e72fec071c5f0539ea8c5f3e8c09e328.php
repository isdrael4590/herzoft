                ...
                <div class="col-lg-12">
                    <div class="printer-inner-9" id="printer_wrapper">
                            ...
                            <div> <table class="default-table">
                                    <thead>
                                        ...
                                        <img src="<?php echo e($institute->getFirstMediaUrl('institutes')); ?>"
                                            ...
                                            <th><h2># <?php echo e($reception->reference); ?></h2>
                                           <h3> <span>     <?php echo e(\Carbon\Carbon::parse($reception->created_up)->format('d M, Y')); ?></span></h3>
                        ...
                        <div class="product-summary">
                                ...
                                <table class="default-table">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                <div>
                                                <div>Persona que entrega: <strong> <?php echo e($reception->delivery_staff); ?></strong></div>
                                    <div>Área Procedente: <strong><?php echo e($reception->area); ?></strong></div>
                                    <div>Persona que recibe:<strong> <?php echo e($reception->operator); ?></strong></div>
                                                </div>
                                            </td>
                                            <td>
                                                <div>
                                                <div>Número: <strong><?php echo e($reception->reference); ?></strong></div>
                                    <div>Fecha: <?php echo e(\Carbon\Carbon::parse($reception->created_up)->format('d M, Y')); ?>
                            ...
                            <div class="product-summary">
                                ...
                                <br>
                                <div>
                                    <?php if(@empty($reception->note)): ?>
                                        Notas: N/A
                                    <?php else: ?>
                                        Notas: <?php echo e($reception->note); ?>
                    ...
                    <table class="default-table ">
                        <tr>
                            ...
                            RECIBE: <span> <?php echo e($reception->operator); ?></span>
                                <br><br><br><br><br><br>
                            </th>
                            <th style= " font-size: 15px; text-align: justify;">
                            ENTREGA: <span> <?php echo e($reception->delivery_staff); ?></span><br><br><br>
...
<?php /**PATH /var/www/html/Modules/Reception/Resources/views/receptions/print4.blade.php ENDPATH**/ ?>