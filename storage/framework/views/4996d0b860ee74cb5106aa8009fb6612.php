<?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('edit_roles')): ?>
    <a href="<?php echo e(route('roles.edit', $data->id)); ?>" class="btn btn-info btn-sm" title="Editar">
...
<?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('delete_roles')): ?>
    <button class="btn btn-danger btn-sm" title="Eliminar"
        ...
        <form id="destroy<?php echo e($data->id); ?>" class="d-none" action="<?php echo e(route('roles.destroy', $data->id)); ?>" method="POST">
            <?php echo csrf_field(); ?>
            <?php echo method_field('delete'); ?>
        </form>
    </button>
<?php endif; ?>
<?php /**PATH /var/www/html/Modules/User/Resources/views/roles/partials/actions.blade.php ENDPATH**/ ?>