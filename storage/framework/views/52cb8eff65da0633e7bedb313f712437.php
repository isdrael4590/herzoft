...
<body>
    <div class="expired-container">
        ...
        <?php if(isset($user)): ?>
        <div class="user-info">
            <p><strong><i class="fas fa-user"></i> Usuario:</strong> <?php echo e($user->name); ?></p>
            <p><strong><i class="fas fa-envelope"></i> Email:</strong> <?php echo e($user->email); ?></p>
        ...
        <?php if(isset($licence) && $licence->license_expiration_date): ?>
        <div class="alert-box">
            <strong><i class="fas fa-calendar-times"></i> Fecha de Expiración:</strong>
            <?php echo e($licence->license_expiration_date->format('d/m/Y')); ?>

            (Expiró hace <?php echo e(now()->diffInDays($licence->license_expiration_date)); ?> días)
        </div>
        <?php endif; ?>

        <div class="contact-info">
            <h5><i class="fas fa-phone-volume"></i> Contacte al Administrador</h5>
            <p><i class="fas fa-envelope"></i> <strong>Email:</strong>  <?php echo e(Settings()->company_email); ?> </p>
            <p><i class="fas fa-phone"></i> <strong>Teléfono:</strong>  <?php echo e(Settings()->company_phone); ?> </p>
...
</html><?php /**PATH /var/www/html/resources/views/errors/licence-expired.blade.php ENDPATH**/ ?>