...
<?php $__env->startSection('breadcrumb'); ?>
    <ol class="breadcrumb border-0 m-0">
        ...
        <li class="breadcrumb-item"><a href="<?php echo e(route('stockDetails.index')); ?>">StockAlmacén</a></li>
                ...
                <div class="card">
                    <div class="card-body">
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('edit_stocks')): ?>
                            <a href="<?php echo e(route('stocks.create')); ?>" class="btn btn-primary">
                                Almancenar Manualmente <i class="bi bi-plus"></i>
                            </a>
                        <?php endif; ?>
                        <hr>
