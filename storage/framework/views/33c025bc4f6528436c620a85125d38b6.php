...
<?php $__env->startSection('breadcrumb'); ?>
    <ol class="breadcrumb border-0 m-0">
        ...
        <li class="breadcrumb-item active">Despachar producto</li>
    </ol>
<?php $__env->stopSection(); ?>
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <a href="<?php echo e(route('expeditions.create')); ?>" class="btn btn-primary">
                            Nuevo Despacho <i class="bi bi-plus"></i>
                        </a>
                        <hr>
