<div class="position-relative" x-data="{
    focusedIndex: -1,
    getItems() {
        return Array.from(document.querySelectorAll('#search-results-list-hpo .search-result-item'));
    },
    moveDown() {
        ...
        <div class="card-body">
            <div class="form-group mb-0">
                <div class="input-group" x-data="{
                    resetQuery(event) {
                        document.getElementById('SearchInputHPO').focus();
                    ...
                    <input
                        ...
                        type="text"
                        class="form-control"
                        placeholder="Escribir Nombre o Código del instrumento HPO (Baja Temperatura)...">
                </div>
            </div>
        </div>
    </div>
        ...
        <!--[if BLOCK]><![endif]--><?php if($search_results->isNotEmpty()): ?>
            <div class="card position-absolute mt-1" style="z-index:9999;left:0;right:0;border:0;">
                <div class="card-body shadow" style="max-height:380px;overflow-y:auto;">
                    <ul id="search-results-list-hpo" class="list-group list-group-flush">
                        <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $search_results; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $result): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <li class="list-group-item list-group-item-action search-result-item"
                                ...
                                <a href="#" :class="focusedIndex === <?php echo e($loop->index); ?> ? 'text-white' : ''">
                                    ...
                                    <!--[if BLOCK]><![endif]--><?php if($result->product_area): ?>
            ...
            <div class="card position-absolute mt-1 border-0" style="z-index:9998;left:0;right:0;">
                <div class="card-body shadow">
                    <div class="alert alert-warning mb-0">
                        <i class="bi bi-exclamation-triangle"></i> Instrumento no encontrado en stock de preparación HPO...
                    </div>
                </div>
            </div>
        <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
...
<?php /**PATH /var/www/html/resources/views/livewire/search-producttoQRHPO.blade.php ENDPATH**/ ?>