<?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($cookieConsentConfig['enabled'] && ! $alreadyConsentedWithCookies): ?>
