    ...
    <div class="container-fluid mb-4">
        ...
        <div class="d-flex align-items-center justify-content-between mb-4">
            <div class="d-flex align-items-center">
                ...
                <div>
                    <h4 class="mb-0 font-weight-bold text-dark">Despacho #<?php echo e($expedition->reference); ?></h4>
                    <small class="text-muted">
                        <?php echo e(\Carbon\Carbon::parse($expedition->created_up)->format('d M, Y')); ?>

                        &nbsp;&bull;&nbsp;
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($expedition->status_expedition == 'Despachado'): ?>
                        ...
                        <?php else: ?>
                            <span class="badge badge-warning" style="font-size:.75rem;padding:4px 10px;border-radius:20px;">
                                <i class="bi bi-clock mr-1"></i> <?php echo e($expedition->status_expedition); ?>
            ...
            <div class="d-flex" style="gap:10px;">
                ...
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('print_expeditions')): ?>
                    <a target="_blank" href="<?php echo e(route('expeditions.pdf', $expedition->id)); ?>"
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="d-flex justify-content-between align-items-center mb-2" style="font-size:.82rem;">
                                <span class="text-muted">
                                    <i class="bi <?php echo e($item['icon']); ?> mr-1" style="color:#10b981;"></i><?php echo e($item['label']); ?>
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $registros; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $reg): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="d-flex align-items-start mb-3">
                                <div class="rounded mr-3 d-flex align-items-center justify-content-center flex-shrink-0"
                                    ...
                                    <i class="bi <?php echo e($reg['icon']); ?>" style="color:<?php echo e($reg['color']); ?>;font-size:.9rem;"></i>
                                </div>
                                <div>
                ...
                <div class="card border-0 h-100" style="border-radius:12px;box-shadow:0 2px 20px rgba(0,0,0,0.08);">
                    ...
                    <div class="card-body d-flex flex-column align-items-center justify-content-center" style="padding:20px;">
                        ...
                        <p class="text-muted mb-1 text-center" style="font-size:.8rem;">
                            <strong><?php echo e($expedition->reference); ?></strong>
                        </p>
        ...
        <div class="card border-0" style="border-radius:12px;box-shadow:0 2px 20px rgba(0,0,0,0.08);">
            <div class="card-header border-0 d-flex align-items-center justify-content-between"
                ...
                <span class="badge" style="font-size:.75rem;padding:5px 12px;border-radius:20px;background:rgba(16,185,129,0.12);color:#059669;">
                    <?php echo e($expedition->expeditionDetails->count()); ?> <?php echo e($expedition->expeditionDetails->count() === 1 ? 'ítem' : 'ítems'); ?>
                ...
                <div class="table-responsive">
                    <table class="table table-hover mb-0">
                        <thead style="background:#f8fafc;">
                            <tr>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = ['Instrumental', 'Código', 'Cantidad', 'Envoltura', 'Expiración', 'Paciente', 'Casa Comercial']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $col): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <tbody>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $expedition->expeditionDetails; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
