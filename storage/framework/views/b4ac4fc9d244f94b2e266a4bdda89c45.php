                    ...
                    <div class="printer-inner-9" id="printer_wrapper">
                                ...
                                <table class="default-table">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>
                                                <h1> <span><?php echo e($expedition->reference); ?></span></h1>
                                                </h4>
                                            </th>
                                            <th>
                        ...
                        <div class="product-summary">
                                ...
                                <table class="default-table">
                                    <thead>
                                        <tr>
                                            ...
                                            <th><strong>Información de Despacho:</strong></h4>
                                            </th>
                                            ...
                                            <td>
                                                <div>
                                                    <div><strong>Temperatura del Ambiente: </strong>
                                                        <?php echo e($expedition->temp_ambiente); ?>

                                                    </div>
                                                    <div><strong>Operario:</strong> <?php echo e($expedition->operator); ?></div>
                                                    <div><strong>Personal Retiro: </strong>
                                                        <?php echo e($expedition->staff_expedition); ?></div>
                                                </div>
                                            </td>
                                            <td>
                                                <div>
                                                    ...
                                                    <div><strong>Area Expedido: </strong>
                                                        <?php echo e($expedition->area_expedition); ?></div>
                                                </div>
                                            </td>
                                        </tr>
                                    </tbody>
                            ...
                            <div class="product-summary">
                                ...
                                <br>
                                <div>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(@empty($expedition->note)): ?>
                                        Notas: N/A
                                    <?php else: ?>
                                        Notas: <?php echo e($expedition->note); ?>
                    ...
                    <table class="default-table ">
                        <tr>
                            <th style= " font-size: 15px; text-align: justify;">
                                ...
                                Emisor: <span> <?php echo e($expedition->operator); ?></span>
                                <br><br><br><br><br><br>
                            </th>
                            <th style= " font-size: 15px; text-align: justify;">
                                Receptor: <span> <?php echo e($expedition->staff_expedition); ?></span><br><br><br><br><br><br>
                            </th>
                        </tr>
                    </table>
...
<?php /**PATH /var/www/html/Modules/Expedition/Resources/views/expeditions/print.blade.php ENDPATH**/ ?>