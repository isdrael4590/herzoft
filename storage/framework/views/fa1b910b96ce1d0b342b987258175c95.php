<?php $__env->startSection('title', 'Editar Producto Stock'); ?>
...
<?php $__env->startSection('content'); ?>
    <div class="container-fluid mb-4">
        ...
        <div class="d-flex align-items-center justify-content-between mb-4">
            <div class="d-flex align-items-center">
                ...
                <div>
                    ...
                    <small class="text-muted">
                        Producto: <strong class="text-dark"><?php echo e($stockDetails->product_name); ?></strong>
                        &nbsp;&bull;&nbsp; Código: <strong class="text-dark"><?php echo e($stockDetails->product_code); ?></strong>
                        &nbsp;&bull;&nbsp;
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($stockDetails->product_status_stock == 'Disponible'): ?>
                        ...
                        <?php elseif($stockDetails->product_status_stock == 'Despachado'): ?>
                        ...
                        <?php else: ?>
                            <span class="badge badge-dark" style="font-size:.75rem;padding:4px 10px;border-radius:20px;">
                                <i class="bi bi-clock mr-1"></i> <?php echo e($stockDetails->product_status_stock); ?>
            ...
            <a href="<?php echo e(route('stockDetails.index')); ?>"
        ...
        <form id="stockDetails-form" action="<?php echo e(route('stockDetails.update', $stockDetails)); ?>" method="POST"
            onsubmit="return handleFormSubmit(event)">
            <?php echo csrf_field(); ?>
            <?php echo method_field('patch'); ?>
            <input type="hidden" name="form_token" value="<?php echo e(uniqid('stock_details_', true)); ?>">
                    ...
                    <div class="form-row">
                        ...
                        <div class="col-lg-3 col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control form-control-sm" name="product_name"
                                value="<?php echo e($stockDetails->product_name); ?>" readonly
                        ...
                        <div class="col-lg-3 col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control form-control-sm" name="product_code"
                                value="<?php echo e($stockDetails->product_code); ?>" readonly
                                style="background:#f8fafc;border-color:#e2e8f0;border-radius:8px;">
                        </div>
                        ...
                        <div class="col-lg-3 col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control form-control-sm" name="product_date_sterilized"
                                value="<?php echo e($stockDetails->product_date_sterilized); ?>" readonly
                                style="background:#f8fafc;border-color:#e2e8f0;border-radius:8px;">
                        </div>
                        ...
                        <div class="col-lg-3 col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control form-control-sm" name="product_expiration"
                                value="<?php echo e($stockDetails->product_expiration); ?>" readonly
                                style="background:#f8fafc;border-color:#e2e8f0;border-radius:8px;">
                        </div>
                    ...
                    <div class="form-row">
                        ...
                        <div class="col-lg-4 col-md-6 mb-3">
                            ...
                            <select class="form-control form-control-sm" id="product_status_stock" name="product_status_stock"
                                ...
                                <option value="Disponible" <?php echo e($stockDetails->product_status_stock == 'Disponible' ? 'selected' : ''); ?>>
                                    Disponible
                                </option>
                                <option value="Despachado" <?php echo e($stockDetails->product_status_stock == 'Despachado' ? 'selected' : ''); ?>>
                                    Despachado
                                </option>
                            </select>
                        </div>
                        ...
                        <div class="col-lg-4 col-md-6 mb-3">
                            ...
                            <input class="form-control form-control-sm" name="product_quantity" type="number"
                                value="<?php echo e($stockDetails->product_quantity); ?>" min="0"
                                style="border-radius:8px;">
                        </div>
                        ...
                        <div class="col-lg-4 col-md-6 mb-3">
                            ...
                            <input class="form-control form-control-sm" name="product_quantity_expedition" type="number"
                                value="<?php echo e($stockDetails->product_quantity_expedition); ?>" min="0"
                                style="border-radius:8px;">
                        </div>
