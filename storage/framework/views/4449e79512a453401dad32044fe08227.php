<?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('edit_discharges')): ?>
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($data->ruta_process == 'Sin Ruta'): ?>
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($data->machine_type == 'Autoclave'): ?>
...
<?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('edit_admin')): ?>
    <a href="<?php echo e(route('discharges.edit', $data->id)); ?>" class="dropdown-item">
        <i class="bi bi-pencil-square mr-2 text-secondary" style="line-height: 1;"></i> Editar Admin
    </a>
<?php endif; ?>

<?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('show_discharges')): ?>
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($data->status_cycle == 'Ciclo Aprobado' || $data->status_cycle == 'Ciclo Falla'): ?>
...
<?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('print_admin')): ?>
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($data->status_cycle == 'Ciclo Aprobado' || $data->status_cycle == 'Ciclo Falla'): ?>
        <a href="<?php echo e(route('discharges.pdf', $data->id)); ?>" class="dropdown-item">
            <i class="bi bi-printer mr-2 text-warning" style="line-height: 1;"></i> Imprimir
        </a>
    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
<?php endif; ?>

<?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('create_discharges_stock')): ?>
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($data->ruta_process != 'Almacenado' && $data->status_cycle == 'Ciclo Aprobado' && $data->validation_biologic == 'Correcto'): ?>
