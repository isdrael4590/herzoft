<?php $__env->startSection('title', 'Editar Test Bowie & Dick'); ?>
...
<?php $__env->startSection('content'); ?>
    <div class="container-fluid">
        <form id="testbd-form" action="<?php echo e(route('testbds.update', $testbd->id)); ?>" method="POST"
            ...
            <div class="d-flex align-items-center justify-content-between mb-4">
                <div class="d-flex align-items-center">
                    ...
                    <div>
                        ...
                        <small class="text-muted">Referencia: <strong><?php echo e($testbd->testbd_reference); ?></strong></small>
                    </div>
                </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group mb-0">
                                ...
                                <input class="form-control" type="text" name="testbd_reference" readonly
                                    value="<?php echo e($testbd->testbd_reference); ?>"
                                ...
                                <select class="form-control" id="machine_name" name="machine_name" required
                                    ...
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = \Modules\Informat\Entities\Machine::all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $machine): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($machine->machine_name); ?>"
                                            <?php echo e($machine->machine_name == $testbd->machine_name ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>"
                                    name="lote_machine" required value="<?php echo e(old('lote_machine', $testbd->lote_machine)); ?>"
                                    style="border-radius:8px;border-color:#e2e8f0;padding:10px 14px;">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <select class="form-control" id="temp_machine" name="temp_machine" required
                                    style="border-radius:8px;border-color:#e2e8f0;padding:10px 14px;">
                                    <option value="134" <?php echo e($testbd->temp_machine == 134 ? 'selected' : ''); ?>>134 °C</option>
                                    <option value="121" <?php echo e($testbd->temp_machine == 121 ? 'selected' : ''); ?>>121 °C</option>
                                </select>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select class="form-control" id="lote_bd" name="lote_bd" required
                                    ...
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = \Modules\Informat\Entities\Informat::all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $informat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($informat->insumo_type == 'TEST BOWIE & DICK' && $informat->insumo_status == 'Activo'): ?>
                                            <option value="<?php echo e($informat->insumo_lot); ?>"
                                                <?php echo e($testbd->lote_bd == $informat->insumo_lot ? 'selected' : ''); ?>>
                                    ...
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!collect(\Modules\Informat\Entities\Informat::where('insumo_type', 'TEST BOWIE & DICK')->where('insumo_status', 'Activo')->pluck('insumo_lot'))->contains($testbd->lote_bd)): ?>
                                        <option value="<?php echo e($testbd->lote_bd); ?>" selected>
                                            <?php echo e($testbd->lote_bd); ?> (inactivo)
                                        </option>
                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                </select>
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select class="form-control" name="validation_bd" id="validation_bd" required
                                    style="border-radius:8px;border-color:#e2e8f0;padding:10px 14px;">
                                    <option value="Correcto" <?php echo e($testbd->validation_bd == 'Correcto' ? 'selected' : ''); ?>>
                                        Correcto
                                    </option>
                                    <option value="Falla" <?php echo e($testbd->validation_bd == 'Falla' ? 'selected' : ''); ?>>
                                        Falla
                                    </option>
                                </select>
                            </div>
...
unset($__errorArgs, $__bag); ?>"
                                        ...
                                        value="<?php echo e(old('temp_ambiente', $testbd->temp_ambiente)); ?>"
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="operator"
                                    value="<?php echo e($testbd->operator); ?>" readonly
                                    style="border-radius:8px;border-color:#e2e8f0;padding:10px 14px;background:#f8fafc;font-weight:600;color:#374151;">
                            </div>
                        </div>
                    </div>
                ...
                <div class="card-body" style="padding:24px;">
                    <div class="form-group mb-0">
                        ...
                        <textarea name="observation" id="observation" rows="4" class="form-control"
                            ...
                            style="border-radius:8px;border-color:#e2e8f0;padding:10px 14px;resize:vertical;"><?php echo e(old('observation', $testbd->observation)); ?></textarea>
                    </div>
                </div>
            </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/Modules/Testbd/Resources/views/testbds/edit.blade.php ENDPATH**/ ?>