    ...
    @can('show_notifications')
        <li class="c-header-nav-item dropdown d-md-down-none mr-2">
            ...
            <div class="dropdown-menu dropdown-menu-right dropdown-menu-lg pt-0">
                ...
                <strong>{{ $low_quantity_products->count() }} Notificationes</strong>
            </div>
            @forelse($low_quantity_products as $product)
                <a class="dropdown-item" href="{{ route('products.show', $product->id) }}">
                    <i class="bi bi-hash mr-1 text-primary"></i> Product: "{{ $product->product_code }}" es baja en cantidad!!.
                </a>
            @empty
                <a class="dropdown-item" href="#">
                    <i class="bi bi-app-indicator mr-2 text-danger"></i> Notificaciones no disponibles.
                </a>
            @endforelse
            --}}
            </div>
