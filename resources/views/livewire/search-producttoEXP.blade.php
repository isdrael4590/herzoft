                        ...
                        @foreach ($search_results as $result)
                            <li class="list-group-item list-group-item-action search-result-item"
                                ...
                                <div class="d-flex justify-content-between align-items-center">
                                    <div>
                                        <i class="bi bi-box-seam mr-1" :class="focusedIndex === {{ $loop->index }} ? 'text-white' : 'text-secondary'"></i>
                                        <strong :class="focusedIndex === {{ $loop->index }} ? 'text-white' : ''">
                                            {{ $result->product_name }}
                                        </strong>
                                        <span class="badge badge-primary ml-1">{{ $result->product_code }}</span>
                                        ...
                                        <small :class="focusedIndex === {{ $loop->index }} ? 'text-white-50' : 'text-muted'">
                                            ...
                                            Vence: {!! \Carbon\Carbon::parse($result->product_expiration)->format('d M, Y') !!}
                                        </small>
                                    </div>
                                </div>
                            </li>
