    ...
    <div class="login-wrapper">
        ...
        <div class="login-brand">
            <div class="login-brand-content">
                @php $logoUrl = settings()->getFirstMediaUrl('settings'); @endphp
                @if ($logoUrl)
                    <img src="{{ $logoUrl }}" alt="Logo" class="login-brand-logo"
                         onerror="this.style.display='none';document.getElementById('logo-placeholder').style.display='flex';">
                @endif
                <div id="logo-placeholder" class="login-brand-logo-placeholder" style="{{ $logoUrl ? 'display:none' : '' }}">
        ...
        <div class="login-form-panel">
            ...
            <footer class="login-footer">
                Desarrollado por
                <a href="http://www.herzgroup.net/" target="_blank">{{ Settings()->company_name }}</a>
                &nbsp;·&nbsp;
                Derechos contratados por
                <a href="http://www.alem.com.ec/" target="_blank">Alem Cia. Ltda.</a>
                <br>
                HerzTrace {{ date('Y') }} &nbsp;·&nbsp; Versión <strong>2.0</strong>
            </footer>
        </div>
    </div>
