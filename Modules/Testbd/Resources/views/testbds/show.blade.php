...
@section('title', 'Detalle Test Bowie & Dick')

@section('breadcrumb')
    <ol class="breadcrumb border-0 m-0">
        <li class="breadcrumb-item"><a href="{{ route('home') }}">Home</a></li>
        <li class="breadcrumb-item"><a href="{{ route('testbds.index') }}">Test Bowie & Dick</a></li>
    ...
    <div class="container-fluid mb-4">
        ...
        <div class="d-flex align-items-center justify-content-between mb-4">
            <div class="d-flex align-items-center">
                ...
                <div>
                    <h4 class="mb-0 font-weight-bold text-dark">{{ $testbd->testbd_reference }}</h4>
                    <small class="text-muted">
                        Equipo: <strong class="text-dark">{{ $testbd->machine_name }}</strong>
                        &nbsp;&bull;&nbsp;
            ...
            <div class="d-flex" style="gap:10px;">
                ...
                @can('print_testbds')
                    <a target="_blank" href="{{ route('testbds.pdf', $testbd->id) }}"
                ...
                @endcan
                @can('edit_testbds')
                    <a href="{{ route('testbds.edit', $testbd->id) }}"
            ...
            <div class="col-lg-8">
                    ...
                    <div class="card-body" style="padding:24px;">
                        <div class="d-flex align-items-start">
                            ...
                            <div>
                                ...
                                <p class="mb-0 font-weight-bold text-dark" style="font-size:1.1rem;">{{ $testbd->testbd_reference }}</p>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="col-md-4 mb-3">
                                <div class="d-flex align-items-start">
                                    ...
                                    <div>
                                        ...
                                        <p class="mb-0 font-weight-semibold text-dark">{{ $testbd->machine_name }}</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-4 mb-3">
                                <div class="d-flex align-items-start">
                                    ...
                                    <div>
                                        ...
                                        <p class="mb-0 font-weight-semibold text-dark">{{ $testbd->lote_machine }}</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-4 mb-3">
                                <div class="d-flex align-items-start">
                                    ...
                                    <div>
                                        ...
                                        <p class="mb-0 font-weight-semibold text-dark">{{ $testbd->temp_machine }} °C</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-md-6 mb-3">
                                <div class="d-flex align-items-start">
                                    ...
                                    <div>
                                        ...
                                        <p class="mb-0 font-weight-semibold text-dark">{{ $testbd->lote_bd }}</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6 mb-3">
                            ...
                            <div class="col-md-6 mb-3">
                                <div class="d-flex align-items-start">
                                    ...
                                    <div>
                                        ...
                                        <p class="mb-0 font-weight-semibold text-dark">{{ $testbd->temp_ambiente }} °C</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6 mb-3">
                                <div class="d-flex align-items-start">
                                    ...
                                    <div>
                                        ...
                                        <p class="mb-0 font-weight-semibold text-dark">{{ $testbd->operator }}</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                @if ($testbd->observation)
                    <div class="card border-0 mb-4" style="border-radius:12px;box-shadow:0 2px 20px rgba(0,0,0,0.08);">
                        ...
                        <div class="card-body" style="padding:24px;">
                            <p class="mb-0 text-dark" style="line-height:1.7;">{{ $testbd->observation }}</p>
                        </div>
                    </div>
                @endif
                ...
                <div class="card border-0 mb-4" style="border-radius:12px;box-shadow:0 2px 20px rgba(0,0,0,0.08);">
                    ...
                    <div class="card-body text-center" style="padding:28px 24px;">
                        ...
                        <div class="d-flex align-items-center justify-content-between mb-2">
                            ...
                            <span class="font-weight-semibold text-dark">{{ $testbd->temp_machine }} °C</span>
                        </div>
                        <div class="d-flex align-items-center justify-content-between">
                            <span class="text-muted" style="font-size:.85rem;">Temperatura ambiente:</span>
                            <span class="font-weight-semibold text-dark">{{ $testbd->temp_ambiente }} °C</span>
                        </div>
                    </div>
                </div>
