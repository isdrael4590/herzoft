...
<head>
    ...
    <style>
        ...
        .table td {
            ...
            border: 1px solid #dee2e6;
            vertical-align: top; /* *** Alineación superior para mejor distribución *** */
            height: {{ $selected_count > 5000 ? 'auto' : 'auto' }}; /* *** Altura automática *** */
        }
        ...
        /* *** NUEVOS ESTILOS: Controlar saltos de página *** */
        .table {
        ...
        /* Evitar que el header se repita innecesariamente */
        .header {
        ...
        @if ($selected_count > 10000)
            ...
            /* *** NUEVA COLUMNA: Productos (más espacio para nombres completos) *** */
...
<body>
    ...
    <table class="table">
        ...
        <tbody>
            @foreach ($receptions as $index => $reception)
                ...
                @if ($selected_count > 5000 && ($index + 1) % 40 == 0 && $index + 1 < $receptions->count())
        </tbody>
    </table>
    ...
    <table class="table">
        ...
        @elseif($selected_count <= 5000 && ($index + 1) % 20 == 0 && $index + 1 < $receptions->count())
        </tbody>
    </table>
    <div class="page-break"></div>
