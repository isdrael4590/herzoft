...
<head>
    <title>Reporte Test de BOWIE & DICK</title>
                        ...
                        <div class="printer-info">
                            <div class="row">
                                ...
                                <div class="printer-number">
                                    <h6 class="print-title-2">Reporte Físico de Test:</h6>
                        ...
                        <div class="product-summary">
                            <div>
                                <table class="default-table printer-table">
                                    ...
                                    <tbody>
                                        @foreach ($data as $testbd)
                                            <tr>

                                                <td>{{ \Carbon\Carbon::parse($testbd->updated_at)->format('d M, Y') }}
                                                </td>
