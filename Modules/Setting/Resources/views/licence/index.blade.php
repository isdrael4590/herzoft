                    ...
                    @if ($licence->isExpired())
                        <div class="alert alert-danger" role="alert">
                            ...
                            <p>La licencia expiró el
                                <strong>{{ $licence->license_expiration_date->format('d/m/Y') }}</strong></p>
                            <hr>
                            <p class="mb-0">
                                <i class="fas fa-users-slash"></i>
                                <strong>{{ $blockedUsersCount }}</strong> usuarios están actualmente bloqueados y no pueden
                                acceder al sistema.
                            </p>
                            <p class="mb-0 mt-2">
                                        ...
                                        @if ($licence && $licence->license_expiration_date)
                                            ...
                                            <h2 class="mb-2 text-{{ $licence->status_color }}">
                                                ...
                                                @else
                                                    ...
                                                    <small
                                                        style="font-size: 0.5em;">{{ $licence->days_remaining == 1 ? 'día' : 'días' }}</small>
                                                @endif
                                            </h2>
                                            ...
                                            <p class="mb-2 text-muted">
                                                ...
                                                Vence:
                                                <strong>{{ $licence->license_expiration_date->format('d/m/Y') }}</strong>
                                            </p>
