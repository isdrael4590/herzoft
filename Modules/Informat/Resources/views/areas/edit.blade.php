                ...
                <div class="d-flex align-items-center">
                    ...
                    <div>
                        ...
                        <small class="text-muted">
                            Modificando: <strong class="text-dark">{{ $area->area_name }}</strong>
                            &nbsp;&bull;&nbsp;
                            <span class="text-muted">{{ $area->area_code }}</span>
                        </small>
                    </div>
                </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input class="form-control @error('area_responsable') is-invalid @enderror"
                                    ...
                                    value="{{ old('area_responsable', $area->area_responsable) }}"
                                    style="border-radius:8px;border-color:#e2e8f0;padding:10px 14px;">
                        ...
                        <div class="col-md-6">
                            <div class="form-group mb-0">
                                ...
                                <input class="form-control @error('area_piso') is-invalid @enderror"
                                    ...
                                    value="{{ old('area_piso', $area->area_piso) }}"
                                    style="border-radius:8px;border-color:#e2e8f0;padding:10px 14px;">
                                @error('area_piso')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
