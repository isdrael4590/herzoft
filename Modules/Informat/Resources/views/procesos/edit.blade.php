                ...
                <div class="d-flex align-items-center">
                    ...
                    <div>
                        ...
                        <small class="text-muted">
                            Modificando: <strong class="text-dark">{{ $proceso->proceso_name }}</strong>
                            &nbsp;&bull;&nbsp;
                            <span class="text-muted">{{ $proceso->proceso_code }}</span>
                        </small>
                    </div>
                </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input class="form-control @error('proceso_name') is-invalid @enderror"
                                    ...
                                    value="{{ old('proceso_name', $proceso->proceso_name) }}"
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select class="form-control @error('proceso_type') is-invalid @enderror"
                                    ...
                                    <option value="ALTA TEMPERATURA" {{ old('proceso_type', $proceso->proceso_type) == 'ALTA TEMPERATURA' ? 'selected' : '' }}>ALTA TEMPERATURA</option>
                                    <option value="BAJA TEMPERATURA" {{ old('proceso_type', $proceso->proceso_type) == 'BAJA TEMPERATURA' ? 'selected' : '' }}>BAJA TEMPERATURA</option>
                                    <option value="LAVADO" {{ old('proceso_type', $proceso->proceso_type) == 'LAVADO' ? 'selected' : '' }}>LAVADO</option>
                                </select>
                                @error('proceso_type')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                        ...
                        <div class="col-md-6">
                            <div class="form-group mb-0">
                              ...
                              <input class="form-control @error('proceso_temp') is-invalid @enderror"
                                    ...
                                    value="{{ old('proceso_temp', $proceso->proceso_temp) }}"
                                    style="border-radius:8px;border-color:#e2e8f0;padding:10px 14px;">
                                @error('proceso_temp')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
