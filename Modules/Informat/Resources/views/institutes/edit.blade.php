        ...
        <form action="{{ route('institute.update', $institute->id) }}" method="POST">
            ...
            <div class="d-flex align-items-center justify-content-between mb-4">
                <div class="d-flex align-items-center">
                    ...
                    <div>
                        <h4 class="mb-0 font-weight-bold text-dark">Editar Institución</h4>
                        <small class="text-muted">
                            Modificando: <strong class="text-dark">{{ $institute->institute_name }}</strong>
                            &nbsp;&bull;&nbsp;
                            <span class="text-muted">{{ $institute->institute_code }}</span>
                        </small>
                    </div>
                </div>
                <div class="d-flex" style="gap:10px;">
                    ...
                    <button type="submit"
                        ...
                        <i class="bi bi-check-lg mr-2"></i> Actualizar Institución
                    </button>
                </div>
            </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control @error('institute_name') is-invalid @enderror"
                                            ...
                                            value="{{ old('institute_name', $institute->institute_name) }}"
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control @error('institute_area') is-invalid @enderror"
                                            ...
                                            value="{{ old('institute_area', $institute->institute_area) }}"
                                            style="border-radius:8px;border-color:#e2e8f0;padding:10px 14px;">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control @error('institute_address') is-invalid @enderror"
                                            ...
                                            value="{{ old('institute_address', $institute->institute_address) }}"
                                            style="border-radius:8px;border-color:#e2e8f0;padding:10px 14px;">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group mb-0">
                                        ...
                                        <input class="form-control @error('institute_city') is-invalid @enderror"
                                            ...
                                            value="{{ old('institute_city', $institute->institute_city) }}"
                                            style="border-radius:8px;border-color:#e2e8f0;padding:10px 14px;">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group mb-0">
                                        ...
                                        <input class="form-control @error('institute_country') is-invalid @enderror"
                                            ...
                                            value="{{ old('institute_country', $institute->institute_country) }}"
                                            style="border-radius:8px;border-color:#e2e8f0;padding:10px 14px;">
