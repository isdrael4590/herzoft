                            ...
                            <div class="form-row">
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        <label for="name">Nombre de la presentación<span class="text-danger">*</span></label>
                                ...
                                <div class="col-lg-12 d-flex justify-content-end">
                                    <div class="form-group">
                                        <button class="btn btn-primary">Actualizar presentación <i class="bi bi-check"></i></button>
                                    </div>
                                </div>
                            </div>
                        </div>
