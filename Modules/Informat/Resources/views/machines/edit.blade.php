                ...
                <div class="d-flex align-items-center">
                    ...
                    <div>
                        ...
                        <small class="text-muted">
                            Modificando: <strong class="text-dark">{{ $Machines->machine_name }}</strong>
                            &nbsp;&bull;&nbsp;
                            <span class="text-muted">{{ $Machines->machine_code }}</span>
                        </small>
                    </div>
                </div>
                    ...
                    <div class="form-row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input class="form-control @error('machine_name') is-invalid @enderror"
                                    type="text" name="machine_name" required
                                    value="{{ old('machine_name', $Machines->machine_name) }}"
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input class="form-control @error('machine_model') is-invalid @enderror"
                                    type="text" name="machine_model" required
                                    value="{{ old('machine_model', $Machines->machine_model) }}"
                                    style="border-radius:8px;border-color:#e2e8f0;padding:10px 14px;">
                                @error('machine_model')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select class="form-control @error('machine_type') is-invalid @enderror"
                                    name="machine_type" id="machine_type" required
                                    style="border-radius:8px;border-color:#e2e8f0;padding:10px 14px;">
                                    <option value="" disabled>-- Seleccionar tipo --</option>
                                    <option value="Autoclave" {{ old('machine_type', $Machines->machine_type) == 'Autoclave' ? 'selected' : '' }}>Autoclave</option>
                                    <option value="Peroxido" {{ old('machine_type', $Machines->machine_type) == 'Peroxido' ? 'selected' : '' }}>Esterilizador de Peróxido</option>
                                </select>
                                @error('machine_type')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input class="form-control @error('machine_serial') is-invalid @enderror"
                                    type="text" name="machine_serial" required
                                    value="{{ old('machine_serial', $Machines->machine_serial) }}"
                                    style="border-radius:8px;border-color:#e2e8f0;padding:10px 14px;">
                    ...
                    <div class="form-row">
                        <div class="col-md-6">
                            <div class="form-group mb-0">
                                ...
                                <input class="form-control @error('machine_factory') is-invalid @enderror"
                                    type="text" name="machine_factory" required
                                    value="{{ old('machine_factory', $Machines->machine_factory) }}"
                                    style="border-radius:8px;border-color:#e2e8f0;padding:10px 14px;">
                                @error('machine_factory')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group mb-0">
                                ...
                                <input class="form-control @error('machine_country') is-invalid @enderror"
                                    type="text" name="machine_country" required
                                    value="{{ old('machine_country', $Machines->machine_country) }}"
                                    style="border-radius:8px;border-color:#e2e8f0;padding:10px 14px;">
                                @error('machine_country')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        </div>
