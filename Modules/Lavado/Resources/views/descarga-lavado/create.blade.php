...
@section('title', 'Registrar Descarga de Lavado')

@section('breadcrumb')
    <ol class="breadcrumb border-0 m-0">
        <li class="breadcrumb-item"><a href="{{ route('home') }}">Home</a></li>
        <li class="breadcrumb-item"><a href="{{ route('lavados.index') }}">Lavados</a></li>
        <li class="breadcrumb-item"><a href="{{ route('lavados.show', $lavado->id) }}">{{ $lavado->reference }}</a></li>
    ...
    <div class="container-fluid mb-4">
        ...
        <div class="d-flex align-items-center justify-content-between mb-4">
            <div class="d-flex align-items-center">
                ...
                <div>
                    ...
                    <small class="text-muted">Proveniente de Lavado <strong>{{ $lavado->reference }}</strong></small>
                </div>
            </div>
            <a href="{{ route('lavados.show', $lavado->id) }}" class="btn btn-outline-secondary d-flex align-items-center"
        ...
        <div class="card border-0 mb-4" style="border-radius:12px;box-shadow:0 2px 20px rgba(0,0,0,0.08);">
            <div class="card-header border-0 d-flex align-items-center"
                ...
                <span class="badge badge-info ml-2">{{ $lavado->lavadoDetalles->count() }} ítem(s)</span>
            </div>
            <div class="card-body" style="padding:20px 24px;">
                <div class="table-responsive">
                    <table class="table table-sm table-hover mb-0">
                        ...
                        <tbody>
                            @forelse($lavado->lavadoDetalles as $det)
                                <tr>
        ...
        <div class="card border-0 mb-4" style="border-radius:12px;box-shadow:0 2px 20px rgba(0,0,0,0.08);">
            ...
            <div class="card-body" style="padding:24px;">
                ...
                <form id="descarga-form" action="{{ route('descarga-lavado.store') }}" method="POST"
                    onsubmit="return handleFormSubmit(event)">
                    @csrf
                    <input type="hidden" name="lavado_id" value="{{ $lavado->id }}">
                        ...
                        <div class="col-lg-3">
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="operator"
                                    value="{{ old('operator', $lavado->operator) }}" required readonly
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="machine_name"
                                    ...
                                    @foreach (\Modules\Informat\Entities\Machine::all() as $machine)
                                        @if ($machine->machine_type == 'Lavadora')
                                            <option value="{{ $machine->machine_name }}"
                                                {{ old('machine_name', $lavado->equipo) === $machine->machine_name ? 'selected' : '' }}>
                        ...
                        <div class="col-lg-2">
                            <div class="form-group">
                                ...
                                <input type="text" name="lote" class="form-control"
                                    value="{{ old('lote', $lavado->lote) }}" required readonly
                                    style="border-radius:8px;border-color:#e2e8f0;padding:10px 14px;">
                            </div>
                        </div>
                        <div class="col-lg-2">
                                    ...
                                    @foreach (\Modules\Informat\Entities\Proceso::all() as $proceso)
                                        @if ($proceso->proceso_type == 'LAVADO')
                                            <option value="{{ $proceso->proceso_name }}"
                                                {{ old('type_program', $lavado->programa_lavado) === $proceso->proceso_name ? 'selected' : '' }}>
                        ...
                        <div class="col-lg-2">
                            <div class="form-group">
                                ...
                                <input type="number" step="0.1" name="temperatura" class="form-control"
                                    value="{{ old('temperatura', $lavado->temperatura) }}" required
                                    style="border-radius:8px;border-color:#e2e8f0;padding:10px 14px;">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="d-flex align-items-center justify-content-between mt-2">
                        ...
                        <div class="d-flex ml-auto" style="gap:10px;">
                            <a href="{{ route('lavados.show', $lavado->id) }}"
