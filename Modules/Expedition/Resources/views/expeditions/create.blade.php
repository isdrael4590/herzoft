...
@section('content')
    <div class="container-fluid mb-4">
            ...
            <div class="d-flex align-items-center">
                ...
                <div>
                    ...
                    <small class="text-muted">
                        Referencia: <strong class="text-dark">{{ $expedition_code }}</strong>
                        &nbsp;&bull;&nbsp; Operador: <strong class="text-dark">{{ Auth::user()->name }}</strong>
                    </small>
                </div>
            </div>
        ...
        <form id="expedition-form" action="{{ route('expeditions.store') }}" method="POST"
            ...
            <input type="hidden" name="reference" value="{{ $expedition_code }}">
                    ...
                    <div class="form-row">
                        ...
                        <div class="col-lg-2 col-md-4 mb-3">
                            ...
                            <input type="text" class="form-control form-control-sm" name="reference_display"
                                value="{{ $expedition_code }}" readonly
                        ...
                        <div class="col-lg-3 col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control form-control-sm" name="staff_expedition" required
                                value="{{ old('staff_expedition') }}" style="border-radius:8px;">
                        </div>
